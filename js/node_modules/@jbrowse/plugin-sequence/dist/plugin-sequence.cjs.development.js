...
var twobit = require('@gmod/twobit');
var indexedfasta = require('@gmod/indexedfasta');
var AbortablePromiseCache = _interopDefault(require('abortable-promise-cache'));
var LRU = _interopDefault(require('@jbrowse/core/util/QuickLRU'));
...
var bgzipFastaAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('BgzipFastaAdapter', {
  fastaLocation: {
    type: 'fileLocation',
    defaultValue: {
...
var chromSizesAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('ChromSizesAdapter', {
  chromSizesLocation: {
    type: 'fileLocation',
    defaultValue: {
...
function Translation(props) {
  ...
  for (var i = 0; i < seqSliced.length; i += 3) {
    ...
    var normalizedCodon = reverse ? util.revcom(codon) : codon;
  ...
  return React.createElement(React.Fragment, null, translated.map(function (element, index) {
    ...
    return React.createElement(React.Fragment, {
      ...
      fill: util.defaultStarts.includes(codon) ? theme.palette.startCodon : util.defaultStops.includes(codon) ? theme.palette.stopCodon : map[Math.abs(frame)]
...
function DNA(props) {
  ...
  var _bpSpanPx = util.bpSpanPx(feature.get('start'), feature.get('end'), region, bpPerPx),
  ...
  return React.createElement(React.Fragment, null, seq.split('').map(function (letter, index) {
    var color$1 = theme.palette.bases[letter.toUpperCase()];
    ...
    return React.createElement(React.Fragment, {
      ...
      dominantBaseline: "middle",
      textAnchor: "middle",
      fill: color$1 ? color.contrastingTextColor(color$1.main) : 'black'
    }, letter) : null);
  }));
}
...
var SequenceSVG = function SequenceSVG(_ref) {
  ...
  var codonTable = util.generateCodonTable(util.defaultCodonTable);
  var height = 20;
  ...
  return React.createElement(React.Fragment, null, showTranslation && (region.reversed ? showReverse : showForward) ? [2, 1, 0].map(function (index) {
    ...
    feature: feature,
    region: region,
    seq: region.reversed ? util.complement(seq) : seq,
    bpPerPx: bpPerPx,
    theme: theme
    ...
    feature: feature,
    region: region,
    seq: region.reversed ? seq : util.complement(seq),
    bpPerPx: bpPerPx,
    theme: theme
...
var DivSequenceRendererReactComponent = /*#__PURE__*/mobxReact.observer(Sequence);

var divSequenceRendererConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('DivSequenceRenderer', {
  height: {
    type: 'number',
...
var indexedFastaAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('IndexedFastaAdapter', {
  fastaLocation: {
    type: 'fileLocation',
    defaultValue: {
      uri: '/path/to/seq.fa'
...
var configSchema = /*#__PURE__*/configuration.ConfigurationSchema('LinearReferenceSequenceDisplay', {
...
function modelFactory(configSchema) {
  return mobxStateTree.types.compose('LinearReferenceSequenceDisplay', pluginLinearGenomeView.BaseLinearDisplay, mobxStateTree.types.model({
    type: mobxStateTree.types.literal('LinearReferenceSequenceDisplay'),
    configuration: configuration.ConfigurationReference(configSchema),
    showForward: mobxStateTree.types.optional(mobxStateTree.types["boolean"], true),
    showReverse: mobxStateTree.types.optional(mobxStateTree.types["boolean"], true),
    showTranslation: mobxStateTree.types.optional(mobxStateTree.types["boolean"], true),
    height: 180
  })).views(function (self) {
    return {
      get renderProps() {
...
var twoBitAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('TwoBitAdapter', {
  twoBitLocation: {
    type: 'fileLocation',
    defaultValue: {
      uri: '/path/to/my.2bit'
...
var configSchemaF = (function (pluginManager) {
  return configuration.ConfigurationSchema('GCContentAdapter', {
...
function createReferenceSeqTrackConfig(pluginManager) {
  return configuration.ConfigurationSchema('ReferenceSequenceTrack', {
    adapter: pluginManager.pluggableConfigSchemaType('adapter'),
    displays: mobxStateTree.types.array(pluginManager.pluggableConfigSchemaType('display')),
    metadata: {
      type: 'frozen',
    ...
    value: function install(pluginManager) {
      ...
      pluginManager.addTrackType(function () {
        ...
        return new TrackType({
          ...
          stateModel: models.createBaseTrackModel(pluginManager, 'ReferenceSequenceTrack', configSchema)
        });
      });
...
var TwoBitAdapter = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
  ...
  function TwoBitAdapter(config) {
    ...
    _this.twobit = new twobit.TwoBitFile(twoBitOpts);
    return _this;
  }
...
//# sourceMappingURL=plugin-sequence.cjs.development.js.map
