...
import { TrackSelector, ContentCopy } from '@jbrowse/core/ui/Icons';
...
import { InputAdornment, Typography as Typography$1, Dialog, DialogTitle, IconButton as IconButton$1, Divider, DialogContent, DialogContentText, TableContainer, Paper as Paper$1, Table, TableHead, TableRow, TableCell, TableBody, Button as Button$1, DialogActions, Container as Container$1, CircularProgress as CircularProgress$1, TextField as TextField$1, makeStyles as makeStyles$1, FormControlLabel, Checkbox } from '@material-ui/core';
...
var ContentBlock = /*#__PURE__*/observer(function (_ref) {
...
var RenderedBlocks = /*#__PURE__*/observer(function (_ref) {
  var model = _ref.model;
  var classes = useStyles$1();
  var blockDefinitions = model.blockDefinitions,
      blockState = model.blockState;
  return /*#__PURE__*/React.createElement(React.Fragment, null, blockDefinitions.map(function (block) {
    if (block instanceof ContentBlock$1) {
      ...
      }, state && state.ReactComponent ? /*#__PURE__*/React.createElement(state.ReactComponent, {
        model: state
      }) : null, state && state.maxHeightReached ? /*#__PURE__*/React.createElement("div", {
    ...
    if (block instanceof ElidedBlock$1) {
      return /*#__PURE__*/React.createElement(ElidedBlock, {
        key: "".concat(model.id, "-").concat(block.key),
        width: block.widthPx
      });
    }

    if (block instanceof InterRegionPaddingBlock$1) {
      return /*#__PURE__*/React.createElement(InterRegionPaddingBlock, {
        key: block.key,
        width: block.widthPx,
        style: {
          background: 'none'
...
function LinearBlocks(_ref2) {
  ...
  }, /*#__PURE__*/React.createElement(RenderedBlocks, {
    model: model
  }));
}
...
var Tooltip = /*#__PURE__*/observer(function (props) {
  ...
  return mouseover ? /*#__PURE__*/React.createElement(Tooltip$1, {
    title: mouseover,
    open: true,
    placement: "right"
...
var LoadingMessage = /*#__PURE__*/observer(function (_ref2) {
  var model = _ref2.model;
  ...
  var _getParent = getParent(model, 2),
      displayStatus = _getParent.message;

  var status = displayStatus || blockStatus;
  return /*#__PURE__*/React.createElement(React.Fragment, null, shown ? /*#__PURE__*/React.createElement("div", {
...
function BlockMessage(_ref3) {
  ...
  var classes = useStyles$3();
  return /*#__PURE__*/React.isValidElement(messageContent) ? /*#__PURE__*/React.createElement("div", {
    className: classes.blockReactNodeMessage
  }, messageContent) : /*#__PURE__*/React.createElement(Typography, {
    variant: "body2",
...
function BlockError(_ref4) {
  ...
  }, "Reload") : null, /*#__PURE__*/React.createElement(Typography, {
    color: "error",
    variant: "body2",
    display: "inline"
  }, "".concat(error)));
...
var ServerSideRenderedBlockContent = /*#__PURE__*/observer(function (_ref5) {
  var model = _ref5.model;

  if (model.error) {
    return /*#__PURE__*/React.createElement(Repeater, null, /*#__PURE__*/React.createElement(BlockError, {
      error: model.error,
      reload: model.reload,
  ...
  if (model.message) {
    return /*#__PURE__*/React.createElement(Repeater, null, /*#__PURE__*/React.createElement(BlockMessage, {
      messageContent: model.message
    }));
  }

  if (!model.filled) {
    return /*#__PURE__*/React.createElement(Repeater, null, /*#__PURE__*/React.createElement(LoadingMessage, {
      model: model
    }));
  }
...
var blockState = /*#__PURE__*/types.model('BlockState', {
  key: types.string,
  region: Region,
...
["volatile"](function () {
  ...
  return {
    afterAttach: function afterAttach() {
      var display = getContainingDisplay(self);
      makeAbortableReaction(self, renderBlockData, renderBlockEffect, // reaction doesn't expect async here
      {
        name: "".concat(display.id, "/").concat(assembleLocString(self.region), " rendering"),
    ...
    beforeDestroy: function beforeDestroy() {
      ...
      var _renderBlockData = renderBlockData(cast(self)),
...
function renderBlockData(self, optDisplay) {
  try {
    var display = optDisplay || getContainingDisplay(self);

    var _getSession2 = getSession(display),
    ...
    var assemblyNames = getTrackAssemblyNames(parentTrack);
    ...
    var sessionId = getRpcSessionId(display);
...
var BaseLinearDisplay$1 = /*#__PURE__*/types.compose('BaseLinearDisplay', BaseDisplay, types.model({
  height: types.optional(types.refinement('displayHeight', types.number, function (n) {
            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return Promise.all(dynamicBlocks.map(function (block) {
                  ...
                  if (cannotBeRenderedReason) {
                    return {
                      reactElement: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
                        x: 0,
                        y: 0,
                        width: width,
                        height: 20,
...
function stateModelFactory(configSchema) {
  return types.compose('LinearBareDisplay', BaseLinearDisplay$1, types.model({
...
function RefNameAutocomplete(_ref) {
  ...
  var debouncedSearch = useDebounce(currentSearch, 350);
  ...
  var limitOption = [{
    ...
    result: new BaseResult({
      refName: '',
      label: '',
      renderingComponent: /*#__PURE__*/React.createElement(Tooltip$1, {
    ...
    renderOption: function renderOption(option, _ref3) {
      ...
      if (currentSearch !== '' && inputValue.length <= rendering.length) {
        return /*#__PURE__*/React.createElement(Typography, {
          noWrap: true
        }, /*#__PURE__*/React.createElement("b", null, rendering.slice(0, inputValue.length)), rendering.slice(inputValue.length));
      }
...
var useStyles$5 = /*#__PURE__*/makeStyles(function (theme) {
  var background = theme.palette.tertiary ? fade(theme.palette.tertiary.main, 0.7) : fade(theme.palette.primary.main, 0.7);
  return {
    rubberBand: {
      height: '100%',
...
function OverviewRubberBand(_ref) {
  var model = _ref.model,
      ...
      ControlComponent = _ref$ControlComponent === void 0 ? /*#__PURE__*/React.createElement("div", null) : _ref$ControlComponent;
  ...
  if (startX === undefined) {
    ...
    }, guideX !== undefined ? /*#__PURE__*/React.createElement(Tooltip$1, {
      open: !mouseDragging,
      placement: "top",
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, rubberBandRef.current ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Popover, {
  ...
  }, /*#__PURE__*/React.createElement(Typography, null, leftBpOffset ? stringify(leftBpOffset) : '')), /*#__PURE__*/React.createElement(Popover, {
    className: classes.popover,
    classes: {
      paper: classes.paper
    },
    ...
    keepMounted: true,
    disableRestoreFocus: true
  }, /*#__PURE__*/React.createElement(Typography, null, rightBpOffset ? stringify(rightBpOffset) : ''))) : null, /*#__PURE__*/React.createElement("div", {
    ref: rubberBandRef,
...
OverviewRubberBand.propTypes = {
  ...
  overview: PropTypes.objectOrObservableObject.isRequired,
  ControlComponent: ReactPropTypes.node
};
OverviewRubberBand.defaultProps = {
  ControlComponent: /*#__PURE__*/React.createElement("div", null)
};
var OverviewRubberBand$1 = /*#__PURE__*/observer(OverviewRubberBand);
...
var ScaleBar = /*#__PURE__*/observer(function (_ref2) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    return !(seq instanceof ContentBlock$1) ? /*#__PURE__*/React.createElement("div", {
...
function OverviewScaleBar(_ref3) {
  ...
  return !displayedRegions.length ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: classes.scaleBar
  ...
  })), /*#__PURE__*/React.createElement("div", null, children)) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(OverviewRubberBand$1, {
    model: model,
    overview: overview,
    ControlComponent: /*#__PURE__*/React.createElement(ScaleBar, {
      model: model,
      overview: overview,
      scale: scale
    })
...
function ZoomControls(_ref) {
  ...
  var _useState = useState(-Math.log2(bpPerPx) * 100),
      _useState2 = _slicedToArray(_useState, 2),
      value = _useState2[0],
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    color: "secondary"
  }, /*#__PURE__*/React.createElement(ZoomOut, null)), /*#__PURE__*/React.createElement(Slider, {
...
var Controls = /*#__PURE__*/observer(function (_ref) {
  ...
  return /*#__PURE__*/React.createElement(Button, {
    ...
    value: "track_select",
    color: "secondary"
  }, /*#__PURE__*/React.createElement(TrackSelector, {
...
var TrackLabel = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var view = getContainingView(track);
  var session = getSession(track);
  ...
  var trackName = getConf(track, 'name');
  ...
  if (getConf(track, 'type') === 'ReferenceSequenceTrack') {
    ...
    session.assemblies.forEach(function (assembly) {
      if (assembly.sequence === trackConf) {
        trackName = "Reference Sequence (".concat(readConfObject(assembly, 'name'), ")");
      }
    });
  }
...
function TrackContainer(props) {
  ...
  function onDragEnter() {
    if (draggingTrackId !== undefined && isAlive(display) && draggingTrackId !== display.id) {
      moveTrack(draggingTrackId, track.id);
    }
  }

  var debouncedOnDragEnter = useDebouncedCallback(onDragEnter, 100);
...
function RubberBand(_ref2) {
  var model = _ref2.model,
      ...
      ControlComponent = _ref2$ControlComponen === void 0 ? /*#__PURE__*/React.createElement("div", null) : _ref2$ControlComponen;
  ...
  if (startX === undefined) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, guideX !== undefined ? /*#__PURE__*/React.createElement(VerticalGuide, {
      model: model,
      coordX: guideX
    }) : null, /*#__PURE__*/React.createElement("div", {
      "data-testid": "rubberBand_controls",
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, rubberBandRef.current ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Popover, {
    className: classes.popover,
    classes: {
      paper: classes.paper
    },
    ...
    keepMounted: true,
    disableRestoreFocus: true
  }, /*#__PURE__*/React.createElement(Typography, null, stringify(leftBpOffset))), /*#__PURE__*/React.createElement(Popover, {
    className: classes.popover,
    classes: {
      paper: classes.paper
    },
    ...
    keepMounted: true,
    disableRestoreFocus: true
  }, /*#__PURE__*/React.createElement(Typography, null, stringify(rightBpOffset)))) : null, /*#__PURE__*/React.createElement("div", {
    ref: rubberBandRef,
    className: classes.rubberBand,
    style: {
      left: left,
  ...
  }, numOfBpSelected.toLocaleString('en-US'), " bp")), /*#__PURE__*/React.createElement("div", {
    "data-testid": "rubberBand_controls",
    className: classes.rubberBandControl,
    role: "presentation",
    ref: controlsRef,
    ...
    onMouseOut: mouseOut,
    onMouseMove: mouseMove
  }, ControlComponent), anchorPosition ? /*#__PURE__*/React.createElement(Menu, {
    anchorReference: "anchorPosition",
    anchorPosition: {
...
var RenderedRefNameLabels = /*#__PURE__*/observer(function (_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, model.staticBlocks.map(function (block, index) {
    return block instanceof ContentBlock$1 && (block.isLeftEndOfDisplayedRegion || index === lastLeftBlock) ? /*#__PURE__*/React.createElement(Typography, {
    ...
    if (block instanceof ContentBlock$1) {
      ...
      return /*#__PURE__*/React.createElement(ContentBlock, {
        ...
        if (tick.type === 'major') {
          ...
          }, baseNumber ? /*#__PURE__*/React.createElement(Typography, {
...
var ScaleBar$1 = /*#__PURE__*/React.forwardRef(function (_ref3, ref) {
  var model = _ref3.model,
      style = _ref3.style,
  ...
  }, /*#__PURE__*/React.createElement(RenderedScaleBarLabels, {
    model: model
  }))), /*#__PURE__*/React.createElement(RenderedRefNameLabels, {
    model: model
  }));
});
var ScaleBar$2 = /*#__PURE__*/observer(ScaleBar$1);
...
function VerticalGuides(_ref2) {
  ...
  }, /*#__PURE__*/React.createElement(RenderedVerticalGuides, {
    model: model
  })));
}
...
function CenterLine(_ref) {
  ...
  }, centerLineInfo && /*#__PURE__*/React.createElement("div", {
...
function TracksContainer(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(VerticalGuides$1, {
    model: model
  }), model.showCenterLine ? /*#__PURE__*/React.createElement(CenterLine$1, {
    model: model
  }) : null, /*#__PURE__*/React.createElement(RubberBand$1, {
    model: model,
    ControlComponent: /*#__PURE__*/React.createElement(ScaleBar$2, {
      model: model,
      style: {
...
function SearchResultsDialog(_ref) {
  ...
  }, "Search Results", handleClose ? /*#__PURE__*/React.createElement(IconButton$1, {
...
var ImportForm = /*#__PURE__*/observer(function (_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", null, model.isSearchDialogDisplayed ? /*#__PURE__*/React.createElement(SearchResultsDialog, {
    model: model,
    ...
    item: true
  }, assemblyName ? selectedRegion !== undefined && model.volatileWidth ? /*#__PURE__*/React.createElement(RefNameAutocomplete$1, {
    model: model,
...
var MiniControls = /*#__PURE__*/observer(function (props) {
  var model = props.model;
  var bpPerPx = model.bpPerPx,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Paper, {
  ...
  }, /*#__PURE__*/React.createElement(ArrowDown, null)), /*#__PURE__*/React.createElement(IconButton, {
    "data-testid": "zoom_out",
    onClick: function onClick() {
      model.zoom(bpPerPx * 2);
    },
    ...
    disabled: bpPerPx <= minBpPerPx + 0.0001 || scaleFactor !== 1,
    color: "secondary"
  }, /*#__PURE__*/React.createElement(ZoomIn, null))), /*#__PURE__*/React.createElement(Menu$1, {
    anchorEl: anchorEl,
    open: Boolean(anchorEl),
    onMenuItemClick: function onMenuItemClick(_, callback) {
      callback();
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            adapterConfig = readConfObject(assemblyConfig, ['sequence', 'adapter']);
...
function SequenceDialog(_ref) {
  ...
  var regionsSelected = useMemo(function () {
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
  ...
  }, "Reference sequence", handleClose ? /*#__PURE__*/React.createElement(IconButton$1, {
    ...
    color: "error"
  }, "".concat(error)) : null, loading && !error ? /*#__PURE__*/React.createElement(Container$1, null, "Retrieving reference sequence...", /*#__PURE__*/React.createElement(CircularProgress$1, {
    style: {
      marginLeft: 10
    },
    size: 20,
...
var useStyles$j = /*#__PURE__*/makeStyles(function () {
  return (
    /* theme */
    {
      majorTickLabel: {
...
function Ruler(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, ticks.map(function (tick) {
...
var Ruler$1 = /*#__PURE__*/observer(Ruler);
...
var LinearGenomeView = /*#__PURE__*/observer(function (_ref) {
  var model = _ref.model;
  ...
  if (!hasDisplayedRegions) {
    return /*#__PURE__*/React.createElement(ImportForm, {
      model: model
    });
  }
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, model.isSeqDialogDisplayed ? /*#__PURE__*/React.createElement(SequenceDialog$1, {
    model: model,
    handleClose: function handleClose() {
      model.setOffsets(undefined, undefined);
    }
  ...
  }) : null, !hideHeader ? /*#__PURE__*/React.createElement(LinearGenomeViewHeader, {
    model: model
  }) : /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'absolute',
  ...
  }, /*#__PURE__*/React.createElement(MiniControls, {
    model: model
  })), error ? /*#__PURE__*/React.createElement(Paper$1, {
    variant: "outlined",
    className: classes.errorMessage
  }, /*#__PURE__*/React.createElement(Typography$1, {
    color: "error"
  }, error.message)) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(TracksContainer$1, {
    model: model
    ...
    return /*#__PURE__*/React.createElement(TrackContainer$1, {
      key: track.id,
      model: model,
      track: track
    });
...
function SVGRuler(_ref3) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("clipPath", {
    ...
    return /*#__PURE__*/React.createElement("g", {
      ...
      y: fontSize,
      fontSize: fontSize
    }, block.refName), renderRuler ? /*#__PURE__*/React.createElement("g", {
      transform: "translate(0 20)",
      clipPath: "url(#clip-ruler)"
    }, /*#__PURE__*/React.createElement(Ruler$1, {
      start: block.start,
      end: block.end,
      bpPerPx: bpPerPx,
...
var SVGHeader = function SVGHeader(_ref4) {
  ...
  return /*#__PURE__*/React.createElement("g", {
    ...
    y: fontSize,
    fontSize: fontSize
  }, assemblyName), /*#__PURE__*/React.createElement("g", {
    transform: "translate(0 ".concat(fontSize, ")")
  }, /*#__PURE__*/React.createElement(ScaleBar$3, {
    model: model,
    fontSize: fontSize
  })), /*#__PURE__*/React.createElement("g", {
    transform: "translate(0 ".concat(rulerHeight, ")")
  }, /*#__PURE__*/React.createElement(SVGRuler, {
    model: model,
    fontSize: fontSize,
    width: width
  })));
...
var SVGRegionSeparators = function SVGRegionSeparators(_ref5) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, dynamicBlocks.contentBlocks.slice(1).map(function (block) {
    return /*#__PURE__*/React.createElement("line", {
      key: block.key,
...
function SVGTracks(_ref6) {
  var displayResults = _ref6.displayResults,
      model = _ref6.model,
      offset = _ref6.offset;
  return /*#__PURE__*/React.createElement(React.Fragment, null, displayResults.map(function (_ref7) {
    var track = _ref7.track,
        result = _ref7.result;
    var current = offset;
    var trackName = getConf(track, 'name') || "Reference sequence (".concat(readConfObject(getParent(track.configuration), 'name'), ")");
    var display = track.displays[0];
    ...
    }, trackName), /*#__PURE__*/React.createElement("g", {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            return _context2.abrupt("return", renderToStaticMarkup( /*#__PURE__*/React.createElement("svg", {
              width: width,
              height: height,
            ...
            }, /*#__PURE__*/React.createElement(SVGHeader, {
              model: model
            }), /*#__PURE__*/React.createElement(SVGTracks, {
              model: model,
              displayResults: displayResults,
              offset: offset
            }), /*#__PURE__*/React.createElement(SVGRegionSeparators, {
              model: model
            })))));
...
function ExportSvgDlg(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
    open: true,
    onClose: handleClose
  }, /*#__PURE__*/React.createElement(DialogTitle, null, "Export SVG", /*#__PURE__*/React.createElement(IconButton$1, {
    className: classes.closeButton,
    onClick: handleClose
...
var useStyles$m = /*#__PURE__*/makeStyles(function (theme) {
  return {
    closeButton: {
      position: 'absolute',
      right: theme.spacing(1),
...
function ReturnToImportFormDialog(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
    ...
    open: true,
    onClose: handleClose
  }, /*#__PURE__*/React.createElement(DialogTitle, null, "Reference sequence", handleClose ? /*#__PURE__*/React.createElement(IconButton$1, {
    className: classes.closeButton,
    onClick: function onClick() {
      handleClose();
    }
...
function calculateVisibleLocStrings(contentBlocks) {
  ...
  var locs = contentBlocks.map(function (block) {
    return assembleLocString(_objectSpread2(_objectSpread2({}, block), {}, {
  ...
  return types.compose(BaseViewModel, types.model('LinearGenomeView', {
    ...
    return {
      ...
      pxToBp: function pxToBp(px) {
        ...
        if (bp < 0) {
          ...
          var offset = bp;
          return _objectSpread2(_objectSpread2({}, getSnapshot(region)), {}, {
            oob: true,
        ...
        for (var index = 0; index < self.displayedRegions.length; index += 1) {
          ...
          if (len + bpSoFar > bp && bpSoFar <= bp) {
            return _objectSpread2(_objectSpread2({}, getSnapshot(_region)), {}, {
              oob: false,
              offset: _offset,
        ...
        if (bp >= bpSoFar) {
          ...
          return _objectSpread2(_objectSpread2({}, getSnapshot(_region2)), {}, {
            oob: true,
            offset: _offset2,
    ...
    return {
      ...
      scrollTo: function scrollTo(offsetPx) {
        var newOffsetPx = clamp(offsetPx, self.minOffset, self.maxOffset);
        self.offsetPx = newOffsetPx;
        return newOffsetPx;
      },
      zoomTo: function zoomTo(bpPerPx) {
        var newBpPerPx = clamp(bpPerPx, self.minBpPerPx, self.maxBpPerPx);
      ...
      horizontallyFlip: function horizontallyFlip() {
        self.displayedRegions = cast(self.displayedRegions.slice().reverse().map(function (region) {
    ...
    return {
      moveTrack: function moveTrack(movingTrackId, targetTrackId) {
        ...
        var track = getSnapshot(self.tracks[oldIndex]);
        self.tracks.splice(oldIndex, 1);
        self.tracks.splice(newIndex, 0, track);
      },
      closeView: function closeView() {
        var parent = getContainingView(self);
      ...
      navToLocString: function navToLocString(locString, optAssemblyName) {
        ...
        if (self.displayedRegions.length > 1) {
          var locations = locStrings.map(function (ls) {
            return parseLocString(ls, isValidRefName);
          });
        ...
        if (displayedRegion) {
          ...
          var start = clamp((_parsedLocString$star = parsedLocString === null || parsedLocString === void 0 ? void 0 : parsedLocString.start) !== null && _parsedLocString$star !== void 0 ? _parsedLocString$star : 0, 0, displayedRegion.end);
          var end = clamp((_parsedLocString$end = parsedLocString === null || parsedLocString === void 0 ? void 0 : parsedLocString.end) !== null && _parsedLocString$end !== void 0 ? _parsedLocString$end : displayedRegion.end, 0, displayedRegion.end);
      ...
      navToMultiple: function navToMultiple(locations) {
        ...
        var lastIndex = findLastIndex(self.displayedRegions, predicate);
        var index;
        ...
        while (index !== lastIndex) {
          try {
            ...
            if (index === -1) {
              throw new Error("could not find a region that completely contained \"".concat(assembleLocString(firstLocation), "\""));
            }
      ...
      getSelectedRegions: function getSelectedRegions(leftOffset, rightOffset) {
        var simView = Base1DView.create(_objectSpread2(_objectSpread2({}, getSnapshot(self)), {}, {
    ...
    function slide(viewWidths) {
      var _springAnimate = springAnimate(self.offsetPx, self.offsetPx + self.width * viewWidths, self.scrollTo),
    ...
    function zoom(targetBpPerPx) {
      ...
      var _springAnimate3 = springAnimate(1, factor, self.setScaleFactor, function () {
...
var stateModelFactory$2 = function stateModelFactory(configSchema) {
  return types.compose('LinearBasicDisplay', BaseLinearDisplay$1, types.model({
    ...
    return {
      ...
      get showLabels() {
        var showLabels = getConf(self, ['renderer', 'showLabels']);
      ...
      get displayMode() {
        var displayMode = getConf(self, ['renderer', 'displayMode']);
  ...
  _createClass(LinearGenomeViewPlugin, [{
    ...
    value: function install(pluginManager) {
      pluginManager.addTrackType(function () {
        var configSchema = ConfigurationSchema('FeatureTrack', {}, {
      ...
      pluginManager.addTrackType(function () {
        var configSchema = ConfigurationSchema('BasicTrack', {}, {
          baseConfiguration: createBaseTrackConfig(pluginManager),
          explicitIdentifier: 'trackId'
        });
        return new TrackType({
...
function SetMaxHeightDlg$1(props) {
  ...
  return /*#__PURE__*/React.createElement(Dialog, {
    ...
    id: "alert-dialog-title"
  }, "Filter options", /*#__PURE__*/React.createElement(IconButton$1, {
    "aria-label": "close",
    className: classes.closeButton,
    onClick: handleClose
