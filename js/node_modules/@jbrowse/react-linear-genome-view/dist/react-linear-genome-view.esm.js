...
import { createJBrowseTheme as createJBrowseTheme$1, Logomark, Menu } from '@jbrowse/core/ui';
import { observer } from 'mobx-react';
import { getEnv, isAlive, types, getParent, walk, isModelType, getType, getMembers, isReferenceType, getSnapshot, cast, onPatch } from 'mobx-state-tree';
import { readConfObject, ConfigurationSchema } from '@jbrowse/core/configuration';
import { Dialog, Paper, makeStyles, AppBar, Toolbar, Typography, useTheme, fade, IconButton, ThemeProvider as ThemeProvider$1 } from '@material-ui/core';
import ScopedCssBaseline from '@material-ui/core/ScopedCssBaseline';
import MenuIcon from '@material-ui/icons/Menu';
import useDimensions from 'react-use-dimensions';
import { getSession, getContainingView } from '@jbrowse/core/util';
import assemblyManagerFactory, { assemblyConfigSchemas } from '@jbrowse/core/assemblyManager';
...
function createJBrowseTheme(theme) {
  ...
  return createJBrowseTheme$1(theme);
}
...
var ModalWidgetContents = /*#__PURE__*/observer(function (_ref) {
  ...
  var _getEnv$pluginManager = getEnv(session).pluginManager.getWidgetType(visibleWidget.type),
  ...
  return React.createElement(React.Fragment, null, React.createElement(AppBar, {
    position: "static"
  }, React.createElement(Toolbar, null, HeadingComponent ? React.createElement(HeadingComponent, {
    model: visibleWidget
  }) : React.createElement(Typography, {
    variant: "h6"
  }, heading))), visibleWidget && ReactComponent ? React.createElement(Suspense, {
    fallback: React.createElement("div", null, "Loading...")
  }, React.createElement(ScopedCssBaseline, null, React.createElement(ReactComponent, {
    model: visibleWidget,
    session: session,
    overrideDimensions: {
...
var ModalWidget = /*#__PURE__*/observer(function (_ref2) {
  ...
  }, React.createElement(ModalWidgetContents, {
    session: session
  })));
});
...
var useStyles$1 = /*#__PURE__*/makeStyles(function (theme) {
  return {
    ...
    iconRoot: {
      '&:hover': {
        backgroundColor: fade(theme.palette.secondary.contrastText, theme.palette.action.hoverOpacity),
        '@media (hover: none)': {
...
var ViewMenu = /*#__PURE__*/observer(function (_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(IconButton, Object.assign({}, IconButtonProps, {
    "aria-label": "more",
  ...
  }), React.createElement(MenuIcon, Object.assign({}, IconProps))), React.createElement(Menu, {
    anchorEl: anchorEl,
...
var ViewContainer = /*#__PURE__*/observer(function (_ref2) {
  var view = _ref2.view,
  ...
  }, session.DialogComponent ? React.createElement(Suspense, {
    fallback: React.createElement("div", null)
  }, React.createElement(session.DialogComponent, Object.assign({
    handleClose: function handleClose() {
      return session.setDialogComponent(undefined, undefined);
    }
  }, session.DialogProps))) : null, React.createElement("div", {
    style: {
      display: 'flex'
    }
  ...
  }), view.displayName ? React.createElement(Typography, {
    variant: "body2",
    className: classes.displayName
  }, view.displayName) : null, React.createElement("div", {
    className: classes.grow
  }), React.createElement("div", {
    style: {
      width: 20,
...
var JBrowseLinearGenomeView = /*#__PURE__*/observer(function (_ref) {
  ...
  var theme = createJBrowseTheme$1(readConfObject(viewState.config.configuration, 'theme'));
  return React.createElement(ThemeProvider$1, {
    theme: theme
  }, React.createElement("div", {
    className: classes.avoidParentStyle
  }, React.createElement(ScopedCssBaseline, null, React.createElement(ViewContainer, {
    key: "view-" + view.id,
    view: view
    ...
    model: view,
    session: session
  }))), React.createElement(ModalWidget, {
    session: session
  }))));
});
...
function createConfigModel(pluginManager, assemblyConfigSchemasType) {
  return types.model('Configuration', {
...
var AboutDialog = /*#__PURE__*/lazy(function () {
  return import('@jbrowse/core/ui/AboutDialog');
});
function sessionModelFactory(pluginManager) {
  return types.model('ReactLinearGenomeViewSession', {
    ...
    activeWidgets: types.map(types.safeReference(pluginManager.pluggableMstType('widget', 'stateModel'))),
    ...
    return {
      ...
      get renderProps() {
        return {
          theme: readConfObject(this.configuration, 'theme')
        };
      },
      ...
      getReferring: function getReferring(object) {
        var refs = [];
        walk(getParent(self), function (node) {
    ...
    return {
      ...
      makeConnection: function makeConnection(configuration, initialSnapshot) {
      ...
      removeReferring: function removeReferring(referring, track, callbacks, dereferenceTypeCount) {
        ...
        referring.forEach(function (_ref2) {
          ...
          try {
            ...
            var view = getContainingView(node);
      ...
      prepareToBreakConnection: function prepareToBreakConnection(configuration) {
        var _this2 = this;
        ...
        var safelyBreakConnection = function safelyBreakConnection() {
          ...
          _this2.breakConnection(configuration);
        };

        return [safelyBreakConnection, dereferenceTypeCount];
      },
      breakConnection: function breakConnection(configuration) {
        var name = readConfObject(configuration, 'name');
        var connection = self.connectionInstances.find(function (c) {
          return c.name === name;
        });
    ...
    var snackbarMessages = observable.array();
    return {
      views: {
...
function createModel(runtimePlugins) {
  ...
  var _createAssemblyConfig = assemblyConfigSchemas(pluginManager),
      assemblyConfigSchemas$1 = _createAssemblyConfig.assemblyConfigSchemas,
      dispatcher = _createAssemblyConfig.dispatcher;

  var assemblyConfigSchemasType = types.union.apply(types, [{
    dispatcher: dispatcher
  }].concat(assemblyConfigSchemas$1));
  var assemblyManagerType = assemblyManagerFactory(assemblyConfigSchemasType, pluginManager);
  var TextSearchManager = pluginManager.load(TextSearchManagerF);
  var rootModel = types.model('ReactLinearGenomeView', {
    ...
    return {
      ...
      renameCurrentSession: function renameCurrentSession(sessionName) {
        if (self.session) {
          var snapshot = JSON.parse(JSON.stringify(getSnapshot(self.session)));
...
export { JBrowseLinearGenomeView, ThemeProvider, createJBrowseTheme, createModel, createViewState, loadPlugins };
//# sourceMappingURL=react-linear-genome-view.esm.js.map
