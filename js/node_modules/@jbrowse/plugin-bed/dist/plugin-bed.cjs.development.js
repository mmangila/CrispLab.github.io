...
var bigBedAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('BigBedAdapter', {
  bigBedLocation: {
    type: 'fileLocation',
    defaultValue: {
      uri: '/path/to/my.bb'
...
var bedTabixAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('BedTabixAdapter', {
  bedGzLocation: {
    type: 'fileLocation',
    defaultValue: {
...
var BedTabixAdapter = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
  ...
  function BedTabixAdapter(config) {
    ...
    _this.scoreColumn = configuration.readConfObject(config, 'scoreColumn');
...
//# sourceMappingURL=plugin-bed.cjs.development.js.map
