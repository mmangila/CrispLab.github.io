...
var SortIcon = _interopDefault(require('@material-ui/icons/Sort'));
var PaletteIcon = _interopDefault(require('@material-ui/icons/Palette'));
var FilterListIcon = _interopDefault(require('@material-ui/icons/ClearAll'));
...
var configSchema = /*#__PURE__*/configuration.ConfigurationSchema('AlignmentsFeatureWidget', {});
function stateModelFactory(pluginManager) {
  return mobxStateTree.types.model('AlignmentsFeatureWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('AlignmentsFeatureWidget'),
...
var configSchema$1 = /*#__PURE__*/mobxStateTree.types.late(function () {
  return configuration.ConfigurationSchema('BamAdapter', {
    bamLocation: {
      type: 'fileLocation',
      defaultValue: {
        uri: '/path/to/my.bam'
    ...
    index: configuration.ConfigurationSchema('BamIndex', {
      indexType: {
        model: mobxStateTree.types.enumeration('IndexType', ['BAI', 'CSI']),
        type: 'stringEnum',
        defaultValue: 'BAI'
      },
      location: {
...
var configSchema$2 = /*#__PURE__*/mobxStateTree.types.late(function () {
  return configuration.ConfigurationSchema('HtsgetBamAdapter', {
    htsgetBase: {
      type: 'string',
      defaultValue: ''
    },
...
var configModelFactory = function configModelFactory(pluginManager) {
  ...
  return configuration.ConfigurationSchema('LinearAlignmentsDisplay', {
...
var stateModelFactory$1 = function stateModelFactory(pluginManager, configSchema) {
  return mobxStateTree.types.compose('LinearAlignmentsDisplay', models.BaseDisplay, mobxStateTree.types.model({
    PileupDisplay: mobxStateTree.types.maybe(pluginManager.getDisplayType('LinearPileupDisplay').stateModel),
    SNPCoverageDisplay: mobxStateTree.types.maybe(pluginManager.getDisplayType('LinearSNPCoverageDisplay').stateModel),
    snpCovHeight: 45,
    type: mobxStateTree.types.literal('LinearAlignmentsDisplay'),
    ...
    return {
      get pileupDisplayConfig() {
        var conf = configuration.getConf(self, 'pileupDisplay');
        var track = util.getContainingTrack(self);
        return _objectSpread2(_objectSpread2({}, conf), {}, {
          type: 'LinearPileupDisplay',
          name: "".concat(configuration.getConf(track, 'name'), " pileup"),
      ...
      get snpCoverageDisplayConfig() {
        var conf = configuration.getConf(self, 'snpCoverageDisplay');
        var track = util.getContainingTrack(self);
        return _objectSpread2(_objectSpread2({}, conf), {}, {
          type: 'LinearSNPCoverageDisplay',
          name: "".concat(configuration.getConf(track, 'name'), " snp coverage"),
    ...
    return {
      afterAttach: function afterAttach() {
        mobxStateTree.addDisposer(self, mobx.autorun(function () {
          ...
          } else if (!deepEqual(self.snpCoverageDisplayConfig, mobxStateTree.getSnapshot(self.SNPCoverageDisplay.configuration))) {
          ...
          } else if (!deepEqual(self.pileupDisplayConfig, mobxStateTree.getSnapshot(self.PileupDisplay.configuration))) {
          ...
          if (self.PileupDisplay.filterBy && !deepEqual(mobxStateTree.getSnapshot(self.PileupDisplay.filterBy), mobxStateTree.getSnapshot(self.SNPCoverageDisplay.filterBy))) {
            self.SNPCoverageDisplay.setFilterBy(mobxStateTree.getSnapshot(self.PileupDisplay.filterBy));
          }

          if (self.PileupDisplay.colorBy && !deepEqual(mobxStateTree.getSnapshot(self.PileupDisplay.colorBy), self.SNPCoverageDisplay.colorBy ? mobxStateTree.getSnapshot(self.SNPCoverageDisplay.colorBy) : {})) {
            self.SNPCoverageDisplay.setColorBy(mobxStateTree.getSnapshot(self.PileupDisplay.colorBy));
          }
        }));
        mobxStateTree.addDisposer(self, mobx.autorun(function () {
          ...
          return runtime_1.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 3:
                  _context.t0 = React__default;
                  _context.t1 = React__default.Fragment;
                  _context.t2 = React__default;
                  _context.next = 8;
...
var LinearAlignmentsDisplayReactComponent = /*#__PURE__*/mobxReact.observer(AlignmentsDisplay);
...
function PileupConfigFactory(pluginManager) {
  ...
  return configuration.ConfigurationSchema('LinearPileupDisplay', {
    defaultRendering: {
      type: 'stringEnum',
      model: mobxStateTree.types.enumeration('Rendering', ['pileup', 'svg']),
      defaultValue: 'pileup'
    },
    ...
    colorScheme: {
      type: 'stringEnum',
      model: mobxStateTree.types.enumeration('colorScheme', ['strand', 'normal', 'insertSize', 'insertSizeAndOrientation', 'mappingQuality', 'tag']),
      description: 'color scheme to use',
      defaultValue: 'normal'
    }
  }, {
    baseConfiguration: pluginLinearGenomeView.linearBasicDisplayConfigSchemaFactory(pluginManager),
    explicitlyTyped: true
  });
}
...
function LinearPileupDisplayBlurb(props) {
  ...
  return sortedBy ? /*#__PURE__*/React__default.createElement("div", {
...
var LinearPileupDisplayBlurb$1 = /*#__PURE__*/mobxReact.observer(LinearPileupDisplayBlurb);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return rpcManager.call(tracks.getRpcSessionId(self), 'PileupGetGlobalValueForTag', _objectSpread2({
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _getSession2 = util.getSession(self), rpcManager = _getSession2.rpcManager;
            sessionId = tracks.getRpcSessionId(self);
            _context2.next = 4;
...
var ColorByTagDlg = /*#__PURE__*/React.lazy(function () {
  return Promise.resolve().then(function () { return ColorByTag$1; });
});
var FilterByTagDlg = /*#__PURE__*/React.lazy(function () {
  return Promise.resolve().then(function () { return FilterByTag$1; });
});
var SortByTagDlg = /*#__PURE__*/React.lazy(function () {
  return Promise.resolve().then(function () { return SortByTag$1; });
});
var SetFeatureHeightDlg = /*#__PURE__*/React.lazy(function () {
...
var ModificationsDlg = /*#__PURE__*/React.lazy(function () {
...
var stateModelFactory$2 = function stateModelFactory(pluginManager, configSchema) {
  return mobxStateTree.types.compose('LinearPileupDisplay', pluginLinearGenomeView.BaseLinearDisplay, mobxStateTree.types.model({
    type: mobxStateTree.types.literal('LinearPileupDisplay'),
    configuration: configuration.ConfigurationReference(configSchema),
    showSoftClipping: false,
    featureHeight: mobxStateTree.types.maybe(mobxStateTree.types.number),
    noSpacing: mobxStateTree.types.maybe(mobxStateTree.types["boolean"]),
    fadeLikelihood: mobxStateTree.types.maybe(mobxStateTree.types["boolean"]),
    trackMaxHeight: mobxStateTree.types.maybe(mobxStateTree.types.number),
    mismatchAlpha: mobxStateTree.types.maybe(mobxStateTree.types["boolean"]),
    sortedBy: mobxStateTree.types.maybe(mobxStateTree.types.model({
      type: mobxStateTree.types.string,
      pos: mobxStateTree.types.number,
      tag: mobxStateTree.types.maybe(mobxStateTree.types.string),
      refName: mobxStateTree.types.string,
      assemblyName: mobxStateTree.types.string
    })),
    colorBy: mobxStateTree.types.maybe(mobxStateTree.types.model({
      type: mobxStateTree.types.string,
      tag: mobxStateTree.types.maybe(mobxStateTree.types.string),
      extra: mobxStateTree.types.frozen()
    })),
    filterBy: mobxStateTree.types.optional(mobxStateTree.types.model({
      flagInclude: mobxStateTree.types.optional(mobxStateTree.types.number, 0),
      flagExclude: mobxStateTree.types.optional(mobxStateTree.types.number, 1536),
      readName: mobxStateTree.types.maybe(mobxStateTree.types.string),
      tagFilter: mobxStateTree.types.maybe(mobxStateTree.types.model({
        tag: mobxStateTree.types.string,
    ...
    return {
      ...
      setColorScheme: function setColorScheme(colorScheme) {
        self.colorTagMap = mobx.observable.map({}); // clear existing mapping

        self.colorBy = mobxStateTree.cast(colorScheme);
        self.ready = false;
      },
    ...
    return {
      afterAttach: function afterAttach() {
        mobxStateTree.addDisposer(self, mobx.autorun( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  view = util.getContainingView(self); // continually generate the vc pairing, set and rerender if any
                  // new values seen
                ...
                case 9:
                  ...
                  _context.next = 12;
                  return getUniqueModificationValues(self, configuration.getConf(self.parentTrack, ['adapter']), colorBy, view.staticBlocks);
      ...
      setSortedBy: function setSortedBy(type, tag) {
        var _getContainingView = util.getContainingView(self),
      ...
      setFilterBy: function setFilterBy(filter) {
        self.filterBy = mobxStateTree.cast(filter);
      }
    };
  }).actions(function (self) {
    ...
    return {
      get maxHeight() {
        var conf = configuration.getConf(self, ['renderers', self.rendererTypeName]) || {};
      ...
      get featureHeightSetting() {
        return self.featureHeight || configuration.readConfObject(this.rendererConfig, 'height');
      },

      get mismatchAlphaSetting() {
        return self.mismatchAlpha !== undefined ? self.mismatchAlpha : configuration.readConfObject(this.rendererConfig, 'mismatchAlpha');
      }
    ...
    return {
      get rendererTypeName() {
        var viewName = configuration.getConf(self, 'defaultRendering');
      ...
      get composedTrackMenuItems() {
        return [{
          ...
          subMenu: [].concat(_toConsumableArray(['Start location', 'Read strand', 'Base pair'].map(function (option) {
            ...
            label: 'Sort by tag...',
            onClick: function onClick() {
              return util.getSession(self).setDialogComponent(SortByTagDlg, {
                model: self
              });
            }
          }, {
          ...
          subMenu: [{
            ...
            onClick: function onClick() {
              util.getSession(self).setDialogComponent(ModificationsDlg, {
                model: self
              });
            }
          }, {
            ...
            label: 'Color by tag...',
            onClick: function onClick() {
              util.getSession(self).setDialogComponent(ColorByTagDlg, {
                model: self
              });
            }
          }]
          ...
          icon: FilterListIcon,
          onClick: function onClick() {
            util.getSession(self).setDialogComponent(FilterByTagDlg, {
              model: self
            });
          }
        }, {
          ...
          onClick: function onClick() {
            util.getSession(self).setDialogComponent(SetFeatureHeightDlg, {
              model: self
            });
          }
        }, {
...
function SNPCoverageConfigFactory(pluginManager) {
  ...
  return configuration.ConfigurationSchema('LinearSNPCoverageDisplay', {
    autoscale: {
      type: 'stringEnum',
      defaultValue: 'local',
      model: mobxStateTree.types.enumeration('Autoscale type', ['local']),
...
function TooltipContents(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement("table", null, /*#__PURE__*/React__default.createElement("caption", null, loc), /*#__PURE__*/React__default.createElement("thead", null, /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("th", null, "Base"), /*#__PURE__*/React__default.createElement("th", null, "Count"), /*#__PURE__*/React__default.createElement("th", null, "% of Total"), /*#__PURE__*/React__default.createElement("th", null, "Strands"), /*#__PURE__*/React__default.createElement("th", null, "Source"))), /*#__PURE__*/React__default.createElement("tbody", null, /*#__PURE__*/React__default.createElement("tr", null, /*#__PURE__*/React__default.createElement("td", null, "Total"), /*#__PURE__*/React__default.createElement("td", null, total), /*#__PURE__*/React__default.createElement("td", null)), Object.entries({
    ref: ref,
    cov: cov,
    noncov: noncov,
    delskips: delskips,
    ...
    return /*#__PURE__*/React__default.createElement(React__default.Fragment, {
      ...
      return /*#__PURE__*/React__default.createElement("tr", {
        key: base
      }, /*#__PURE__*/React__default.createElement("td", null, base.toUpperCase()), /*#__PURE__*/React__default.createElement("td", null, score.total), /*#__PURE__*/React__default.createElement("td", null, base === 'total' ? '---' : "".concat(Math.floor(score.total / total * 100), "%")), /*#__PURE__*/React__default.createElement("td", null, strands['-1'] ? "".concat(strands['-1'], "(-)") : '', strands['1'] ? "".concat(strands['1'], "(+)") : ''), /*#__PURE__*/React__default.createElement("td", null, key));
    }));
  }))));
}

var Tooltip = /*#__PURE__*/mobxReact.observer(function (_ref6) {
  var model = _ref6.model,
      height = _ref6.height,
      mouseCoord = _ref6.mouseCoord;
  var featureUnderMouse = model.featureUnderMouse;
  var classes = useStyles();
  return featureUnderMouse ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(MUITooltip, {
    placement: "right-start",
    className: classes.popper,
    open: true,
    title: /*#__PURE__*/React__default.createElement(TooltipContents, {
...
var stateModelFactory$3 = function stateModelFactory(pluginManager, configSchema) {
  return mobxStateTree.types.compose('LinearSNPCoverageDisplay', pluginWiggle.linearWiggleDisplayModelFactory(pluginManager, configSchema), mobxStateTree.types.model({
    type: mobxStateTree.types.literal('LinearSNPCoverageDisplay'),
    drawInterbaseCounts: mobxStateTree.types.maybe(mobxStateTree.types["boolean"]),
    drawIndicators: mobxStateTree.types.maybe(mobxStateTree.types["boolean"]),
    filterBy: mobxStateTree.types.optional(mobxStateTree.types.model({
      flagInclude: mobxStateTree.types.optional(mobxStateTree.types.number, 0),
      flagExclude: mobxStateTree.types.optional(mobxStateTree.types.number, 1536),
      readName: mobxStateTree.types.maybe(mobxStateTree.types.string),
    ...
    return {
      ...
      setColorBy: function setColorBy(colorBy) {
        self.colorBy = mobxStateTree.cast(colorBy);
      },
      updateModificationColorMap: function updateModificationColorMap(uniqueModifications) {
        var colorPalette = ['red', 'blue', 'green', 'orange', 'purple'];
        var i = 0;
    ...
    return {
      ...
      get drawInterbaseCountsSetting() {
        return self.drawInterbaseCounts !== undefined ? self.drawInterbaseCounts : configuration.readConfObject(this.rendererConfig, 'drawInterbaseCounts');
      },

      get drawIndicatorsSetting() {
        return self.drawIndicators !== undefined ? self.drawIndicators : configuration.readConfObject(this.rendererConfig, 'drawIndicators');
      },
      ...
      get renderProps() {
        return _objectSpread2(_objectSpread2(_objectSpread2({}, self.composedRenderProps), tracks.getParentRenderProps(self)), {}, {
          ...
          colorBy: self.colorBy ? mobxStateTree.getSnapshot(self.colorBy) : undefined
        });
      }
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.prev = 0;
                  colorBy = self.colorBy;
                  _getContainingView = util.getContainingView(self), staticBlocks = _getContainingView.staticBlocks;
                  ...
                  _context.next = 6;
                  return getUniqueModificationValues(self, configuration.getConf(self.parentTrack, 'adapter'), colorBy, staticBlocks);
    ...
    return {
      ...
      get adapterConfig() {
        var subadapter = configuration.getConf(self.parentTrack, 'adapter');
        return {
...
function PileupRendering(props) {
  ...
  var highlightOverlayCanvas = React.useRef(null);
  ...
  React.useEffect(function () {
    ...
    if (selectedFeatureId && (blockLayout = blockLayoutFeatures.get(blockKey)) && (rect = blockLayout.get(selectedFeatureId))) {
      ...
      var _bpSpanPx = util.bpSpanPx(leftBp, rightBp, region, bpPerPx),
    ...
    if (highlightedFeature && (blockLayout = blockLayoutFeatures.get(blockKey)) && (rect = blockLayout.get(highlightedFeature))) {
      ...
      var _bpSpanPx3 = util.bpSpanPx(_leftBp, _rightBp, region, bpPerPx),
  ...
  }, /*#__PURE__*/React__default.createElement(ui.PrerenderedCanvas, Object.assign({}, props, {
    style: {
      position: 'absolute',
      left: 0,
      top: 0
...
var PileupRendererReactComponent = /*#__PURE__*/mobxReact.observer(PileupRendering);

var pileupRendererConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('PileupRenderer', {
  color: {
    type: 'color',
  ...
  orientationType: {
    type: 'stringEnum',
    model: /*#__PURE__*/mobxStateTree.types.enumeration('orientationType', ['fr', 'rf', 'ff']),
    defaultValue: 'fr',
  ...
  displayMode: {
    type: 'stringEnum',
    model: /*#__PURE__*/mobxStateTree.types.enumeration('displayMode', ['normal', 'compact', 'collapse']),
...
var sortFeature = function sortFeature(features, sortedBy) {
  ...
  featureArray.forEach(function (innerArray) {
    ...
    if (range.doesIntersect2(pos - 1, pos, start, end)) {
    ...
    get: function get() {
      if (!this.cachedLayout || !this.cachedLayoutIsValid(this.cachedLayout)) {
        this.cachedLayout = {
          ...
          config: configuration.readConfObject(this.config),
          filters: this.filters,
...
var PileupRenderer = /*#__PURE__*/function (_BoxRendererType) {
  ...
  _createClass(PileupRenderer, [{
    ...
    value: function layoutFeature(feature, layout, config, bpPerPx, region, showSoftClip) {
      ...
      var _bpSpanPx = util.bpSpanPx(feature.get('start') - expansionBefore, feature.get('end') + expansionAfter, region, bpPerPx),
          _bpSpanPx2 = _slicedToArray(_bpSpanPx, 2),
          leftPx = _bpSpanPx2[0],
          rightPx = _bpSpanPx2[1];

      var heightPx = configuration.readConfObject(config, 'height', {
        feature: feature
      });
      var displayMode = configuration.readConfObject(config, 'displayMode', {
        feature: feature
      });
    ...
    value: function getExpandedRegion(region, renderArgs) {
      ...
      var maxClippingSize = configuration.readConfObject(config, 'maxClippingSize');
    ...
    value: function getOrientation(feature, config) {
      var orientationType = configuration.readConfObject(config, 'orientationType');
      ...
      for (var j = fstart; j < fend; j++) {
        ...
        if (i >= 0 && i < methBins.length) {
          ...
          if (l1.toUpperCase() === 'C' && l2.toUpperCase() === 'G') {
            var _bpSpanPx7 = util.bpSpanPx(rstart + i, rstart + i + 1, region, bpPerPx),
    ...
    value: function drawRect(ctx, feat, props) {
      ...
      var _bpSpanPx9 = util.bpSpanPx(feature.get('start'), feature.get('end'), region, bpPerPx),
    ...
    value: function drawAlignmentRect(ctx, feat, props) {
      ...
      switch (colorType) {
        ...
        case 'normal':
        default:
          ctx.fillStyle = configuration.readConfObject(config, 'color', {
            feature: feature
          });
          break;
      }
    ...
    value: function drawMismatches(ctx, feat, props, theme, colorForBase, opts) {
      ...
      var start = feature.get('start');
      var minFeatWidth = configuration.readConfObject(config, 'minSubfeatureWidth');
      var insertionScale = configuration.readConfObject(config, 'largeInsertionIndicatorScale');
      ...
      for (var i = 0; i < mismatches.length; i += 1) {
        ...
        var _bpSpanPx11 = util.bpSpanPx(start + mismatch.start, start + mismatch.start + mismatch.length, region, bpPerPx),
      ...
      if (drawIndels) {
        for (var _i = 0; _i < mismatches.length; _i += 1) {
          ...
          var _bpSpanPx13 = util.bpSpanPx(feature.get('start') + _mismatch.start, feature.get('start') + _mismatch.start + _mismatch.length, region, bpPerPx),
      ...
      if (seq) {
        mismatches.filter(function (mismatch) {
          ...
          for (var k = 0; k < softClipLength; k += 1) {
            ...
            var _bpSpanPx15 = util.bpSpanPx(softClipStart + k, softClipStart + k + 1, region, bpPerPx),
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                mismatchAlpha = configuration.readConfObject(config, 'mismatchAlpha');
    ...
    value: function layoutFeats(props) {
      ...
      var layoutRecords = util.iterMap(featureMap.values(), function (feature) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                _context2.next = 9;
                return dataAdapterCache.getAdapter(this.pluginManager, renderProps.sessionId, // @ts-ignore
        ...
        return runtime_1.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 15:
                return _context4.abrupt("return", features.pipe(operators.reduce(function (bins, feature) {
                  var cigar = feature.get('CIGAR');
                  var fstart = feature.get('start');
                  var fend = feature.get('end');
...
var ConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('SNPCoverageRenderer', {
  clipColor: {
    type: 'color',
...
var SNPCoverageRenderer = /*#__PURE__*/function (_WiggleBaseRenderer) {
  ...
  _createClass(SNPCoverageRenderer, [{
    ...
    function draw(ctx, props) {
      ...
      var drawIndicators = configuration.readConfObject(cfg, 'drawIndicators'); // get the y coordinate that we are plotting at, this can be log scale
...
}(pluginWiggle.WiggleBaseRenderer);

var configSchema$3 = /*#__PURE__*/configuration.ConfigurationSchema('SNPCoverageRenderer', {}, {
        ...
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                return _context.abrupt("return", util.renameRegionsIfNeeded(assemblyManager, args));
        ...
        return runtime_1.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 4:
                return _context3.abrupt("return", util.renameRegionsIfNeeded(assemblyManager, args));
  ...
  _createClass(AlignmentsPlugin, [{
    ...
    value: function install(pluginManager) {
      pluginManager.addTrackType(function () {
        var configSchema = configuration.ConfigurationSchema('AlignmentsTrack', {}, {
          baseConfiguration: models.createBaseTrackConfig(pluginManager)
        });
        var track = new TrackType({
          name: 'AlignmentsTrack',
          configSchema: configSchema,
          stateModel: models.createBaseTrackModel(pluginManager, 'AlignmentsTrack', configSchema)
        });
      ...
      pluginManager.addDisplayType(function () {
        ...
        return new DisplayType({
          ...
          trackType: 'AlignmentsTrack',
          viewType: 'LinearGenomeView',
          ReactComponent: pluginWiggle.LinearWiggleDisplayReactComponent
        });
      });
      pluginManager.addDisplayType(function () {
      ...
      pluginManager.addRendererType(function () {
        return new SNPCoverageRenderer({
          ...
          ReactComponent: pluginWiggle.WiggleRendering,
...
var BamAdapter = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
  ...
  _createClass(BamAdapter, [{
    ...
    function () {
      var _configure = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        var bamLocation, location, indexType, chunkSizeLimit, fetchSizeLimit, bam$1, adapterConfig;
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!this.configured) {
                  ...
                  bam$1 = new bam.BamFile({
                    bamFilehandle: io.openLocation(bamLocation),
                    csiFilehandle: indexType === 'CSI' ? io.openLocation(location) : undefined,
                    baiFilehandle: indexType !== 'CSI' ? io.openLocation(location) : undefined,
      ...
      var _configure = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        ...
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                cramLocation = configuration.readConfObject(this.config, 'cramLocation');
                craiLocation = configuration.readConfObject(this.config, 'craiLocation');
              ...
              case 6:
                this.cram = new cram.IndexedCramFile({
                  cramFilehandle: io.openLocation(cramLocation),
                  index: new cram.CraiIndex({
                    filehandle: io.openLocation(craiLocation)
                  }),
              ...
              case 10:
                _context.next = 12;
                return this.getSubAdapter(configuration.readConfObject(this.config, 'sequenceAdapter'));
...
var HtsgetBamAdapter = /*#__PURE__*/function (_BamAdapter) {
  ...
  _createClass(HtsgetBamAdapter, [{
    ...
    value: function () {
      var _configure = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
        var htsgetBase, htsgetTrackId, bam$1, adapterConfig;
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!this.configured) {
                  htsgetBase = configuration.readConfObject(this.config, 'htsgetBase');
                  htsgetTrackId = configuration.readConfObject(this.config, 'htsgetTrackId');
                  bam$1 = new bam.HtsgetFile({
                    baseUrl: htsgetBase,
...
function ColorByTagDlg$1(props) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    open: true,
    onClose: handleClose
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Color by tag", /*#__PURE__*/React__default.createElement(core.IconButton, {
    "aria-label": "close",
...
function Bitmask(props) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(core.TextField, {
    type: "number",
    value: flag,
    onChange: function onChange(event) {
...
function FilterByTagDlg$1(props) {
  ...
  var _useState3 = React.useState(filterBy === null || filterBy === void 0 ? void 0 : filterBy.flagExclude),
      _useState4 = _slicedToArray(_useState3, 2),
      flagExclude = _useState4[0],
      setFlagExclude = _useState4[1];

  var _useState5 = React.useState((filterBy === null || filterBy === void 0 ? void 0 : (_filterBy$tagFilter = filterBy.tagFilter) === null || _filterBy$tagFilter === void 0 ? void 0 : _filterBy$tagFilter.tag) || ''),
      _useState6 = _slicedToArray(_useState5, 2),
      tag = _useState6[0],
      setTag = _useState6[1];

  var _useState7 = React.useState((filterBy === null || filterBy === void 0 ? void 0 : (_filterBy$tagFilter2 = filterBy.tagFilter) === null || _filterBy$tagFilter2 === void 0 ? void 0 : _filterBy$tagFilter2.value) || ''),
      _useState8 = _slicedToArray(_useState7, 2),
      tagValue = _useState8[0],
      setTagValue = _useState8[1];

  var _useState9 = React.useState((filterBy === null || filterBy === void 0 ? void 0 : filterBy.readName) || ''),
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
  ...
  }, /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(core.Typography, null, "Read must have ALL these flags"), /*#__PURE__*/React__default.createElement(Bitmask, {
    flag: flagInclude,
    setFlag: setFlagInclude
  })), /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(core.Typography, null, "Read must have NONE of these flags"), /*#__PURE__*/React__default.createElement(Bitmask, {
    flag: flagExclude,
    setFlag: setFlagExclude
  })))), /*#__PURE__*/React__default.createElement(core.Paper, {
    className: classes.paper,
    variant: "outlined"
  }, /*#__PURE__*/React__default.createElement(core.Typography, null, "Filter by tag name and value. Use * in the value field to get all reads containing any value for that tag. Example: filter tag name SA with value * to get all split/supplementary reads. Other examples include HP for haplotype, or RG for read group"), /*#__PURE__*/React__default.createElement(core.TextField, {
    ...
    className: classes.paper,
    variant: "outlined"
  }, /*#__PURE__*/React__default.createElement(core.Typography, null, "Filter by read name"), /*#__PURE__*/React__default.createElement(core.TextField, {
    className: classes.field,
    value: readName,
    onChange: function onChange(event) {
...
function SortByTagDlg$1(props) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    open: true,
    onClose: handleClose
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Sort by tag", /*#__PURE__*/React__default.createElement(core.IconButton, {
    "aria-label": "close",
    className: classes.closeButton,
    onClick: handleClose
...
function SetFeatureHeightDlg$1(props) {
  ...
  var _useState = React.useState("".concat(featureHeightSetting)),
      _useState2 = _slicedToArray(_useState, 2),
      height = _useState2[0],
      setHeight = _useState2[1];

  var _useState3 = React.useState(noSpacingSetting),
      _useState4 = _slicedToArray(_useState3, 2),
...
function ModificationTable(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("table", {
    ...
    return /*#__PURE__*/React__default.createElement("tr", {
      key: key
    }, /*#__PURE__*/React__default.createElement("td", null, key), /*#__PURE__*/React__default.createElement("td", null, value), /*#__PURE__*/React__default.createElement("td", {
      style: {
        width: '1em',
        background: value
      }
...
function ColorByTagDlg$2(props) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    open: true,
    onClose: handleClose
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Color by modifications", /*#__PURE__*/React__default.createElement(core.IconButton, {
    "aria-label": "close",
    className: classes.closeButton,
    onClick: handleClose
  }, /*#__PURE__*/React__default.createElement(CloseIcon, null))), /*#__PURE__*/React__default.createElement(core.DialogContent, null, /*#__PURE__*/React__default.createElement("div", {
  ...
  }, (colorBy === null || colorBy === void 0 ? void 0 : colorBy.type) === 'modifications' ? /*#__PURE__*/React__default.createElement("div", null, modifications.length ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, "Current modification-type-to-color mapping", /*#__PURE__*/React__default.createElement(ModificationTable, {
    modifications: _toConsumableArray(modificationTagMap.entries())
  })) : /*#__PURE__*/React__default.createElement("div", null, /*#__PURE__*/React__default.createElement(core.Typography, null, "Note: color by modifications is already enabled. Loading current modifications..."), /*#__PURE__*/React__default.createElement(core.CircularProgress, {
    size: 15
  ...
  }, "Modifications"), /*#__PURE__*/React__default.createElement(core.Button, {
    variant: "contained",
    color: "primary",
    style: {
      margin: 5
  ...
  }, "Methylation"), /*#__PURE__*/React__default.createElement(core.Button, {
    variant: "contained",
    color: "secondary",
    style: {
      margin: 5
...
function AlignmentFlags(props) {
  ...
  return /*#__PURE__*/React__default.createElement(BaseFeatureDetail.BaseCard, Object.assign({}, props, {
    title: "Flags"
  }), /*#__PURE__*/React__default.createElement(BaseFeatureDetail.SimpleValue, {
    name: 'Flag',
    value: flags
  }), /*#__PURE__*/React__default.createElement(core.FormGroup, null, flagNames.map(function (name, index) {
...
function Formatter(_ref) {
  ...
  if (display.length > 100) {
    ...
    }, "Copy"), /*#__PURE__*/React__default.createElement("button", {
      type: "button",
      onClick: function onClick() {
    ...
    }, show ? 'Show less' : 'Show more'), /*#__PURE__*/React__default.createElement("div", null, show ? display : "".concat(display.slice(0, 100), "...")));
  }

  return /*#__PURE__*/React__default.createElement("div", null, display);
...
function SupplementaryAlignments(props) {
  ...
  }), /*#__PURE__*/React__default.createElement(core.Typography, null, "List of supplementary alignment locations"), /*#__PURE__*/React__default.createElement("ul", null, tag.split(';').filter(function (SA) {
    return !!SA;
...
function AlignmentFeatureDetails(props) {
  ...
  }, /*#__PURE__*/React__default.createElement(BaseFeatureDetail.FeatureDetails, Object.assign({}, props, {
    omit: omit,
    feature: feat,
    formatter: function formatter(value, key) {
      return key === 'next_segment_position' ? /*#__PURE__*/React__default.createElement(PairLink, {
        model: model,
        locString: value
      }) : /*#__PURE__*/React__default.createElement(Formatter, {
        value: value
      });
    }
  })), SA ? /*#__PURE__*/React__default.createElement(SupplementaryAlignments, {
    model: model,
    tag: SA
  }) : null, /*#__PURE__*/React__default.createElement(AlignmentFlags, Object.assign({
    feature: feat
  }, props)));
}

var AlignmentsFeatureDetail = /*#__PURE__*/mobxReact.observer(AlignmentFeatureDetails);
...
//# sourceMappingURL=plugin-alignments.cjs.development.js.map
