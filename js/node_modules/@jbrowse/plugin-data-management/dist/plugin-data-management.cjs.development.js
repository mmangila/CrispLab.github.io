...
var FileSelector = _interopDefault(require('@jbrowse/core/ui/FileSelector'));
var pluginConfig = require('@jbrowse/plugin-config');
...
var ucscConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('UCSCTrackHubConnection', {
  hubTxtLocation: {
    type: 'fileLocation',
    defaultValue: {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return io.openLocation(hubFileLocation).readFile('utf8');
    ...
    return runtime_1.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return io.openLocation(genomesFileLocation).readFile('utf8');
...
function generateTracks(trackDb, trackDbFileLocation, assemblyName, sequenceAdapter) {
  ...
  trackDb.forEach(function (track, trackName) {
    ...
    res.trackId = "ucsc-trackhub-".concat(util.objectHash(res));
...
function makeTrackConfig(track, categories, trackDbFileLocation, trackDb, sequenceAdapter) {
  ...
  switch (baseTrackType) {
    ...
    case 'bed':
      return tracks.generateUnsupportedTrackConf(track.get('shortLabel'), baseTrackType, categories);
    ...
    default:
      return tracks.generateUnknownTrackConf(track.get('shortLabel'), baseTrackType, categories);
  }
}

function UCSCTrackHubConnection(pluginManager) {
  return mobxStateTree.types.compose('UCSCTrackHubConnection', models.BaseConnectionModelFactory(pluginManager), mobxStateTree.types.model({
    configuration: configuration.ConfigurationReference(ucscConfigSchema),
    type: mobxStateTree.types.literal('UCSCTrackHubConnection')
          ...
          try {
            var _loop = function _loop() {
              ...
              var assemblyConf = session.assemblies.find(function (assembly) {
                return configuration.readConfObject(assembly, 'name') === genomeName;
              });
...
function f(pluginManager) {
  return mobxStateTree.types.model('AddTrackModel', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('AddTrackWidget'),
    ...
    return {
      ...
      get unsupported() {
        ...
        return ((_this$trackAdapter = this.trackAdapter) === null || _this$trackAdapter === void 0 ? void 0 : _this$trackAdapter.type) === tracks.UNSUPPORTED;
      },
...
var configSchema = /*#__PURE__*/configuration.ConfigurationSchema('AddTrackWidget', {});

var AddConnectionStateModel = /*#__PURE__*/mobxStateTree.types.model('AddConnectionModel', {
  id: mst.ElementId,
  type: /*#__PURE__*/mobxStateTree.types.literal('AddConnectionWidget')
});

var configSchema$1 = /*#__PURE__*/configuration.ConfigurationSchema('AddConnectionWidget', {});
...
function getTrackName(config) {
  ...
  return configuration.readConfObject(config, 'name') || "Reference sequence (".concat(configuration.readConfObject(mobxStateTree.getParent(config), 'name'), ")");
}
...
function generateHierarchy(model, trackConfigurations, collapsed) {
  ...
  trackConfigurations.filter(function (trackConf) {
    ...
    var categories = _toConsumableArray(configuration.readConfObject(trackConf, 'category') || []); // silly thing where if trackId ends with sessionTrack, then push it to
...
var HierarchicalTrackSelectorStateModelFactory = (function (pluginManager) {
  return mobxStateTree.types.model('HierarchicalTrackSelectorWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('HierarchicalTrackSelectorWidget'),
    collapsed: mobxStateTree.types.map(mobxStateTree.types["boolean"]),
    filterText: '',
    view: mobxStateTree.types.safeReference(pluginManager.pluggableMstType('view', 'stateModel')),
    collapsedCategories: mobxStateTree.types.map(mobxStateTree.types.string, mobxStateTree.types["boolean"])
  }).actions(function (self) {
    return {
    ...
    return {
      ...
      trackConfigurations: function trackConfigurations(assemblyName) {
        ...
        return (refseq ? [refseq] : []).concat(_toConsumableArray(trackConfigurations.filter(function (conf) {
          var trackConfAssemblies = configuration.readConfObject(conf, 'assemblyNames');
      ...
      hierarchy: function hierarchy(assemblyName) {
        ...
        var conns = session.connectionInstances.filter(function (conn) {
          var configAssemblyNames = configuration.readConfObject(conn.configuration, 'assemblyNames');
          ...
          return {
            id: c.connectionId,
            name: configuration.readConfObject(c, 'name'),
...
function PluginDialog(_ref) {
  ...
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, /*#__PURE__*/React__default.createElement(core.IconButton, {
  ...
  }, "Confirm"), /*#__PURE__*/React__default.createElement(core.Button, {
    variant: "contained",
    color: "secondary",
    onClick: function onClick() {
      _onClose();
...
function InstalledPlugin(_ref2) {
  ...
  var rootModel = mobxStateTree.getParent(model, 3);
  var jbrowse = rootModel.jbrowse,
      adminMode = rootModel.adminMode;
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, dialogPlugin ? /*#__PURE__*/React__default.createElement(PluginDialog, {
    plugin: dialogPlugin,
  ...
  }) : null, /*#__PURE__*/React__default.createElement(core.ListItem, {
    key: plugin.name
  }, adminMode || isSessionPlugin ? /*#__PURE__*/React__default.createElement(core.IconButton, {
    "aria-label": "removePlugin",
    "data-testid": "removePlugin-".concat(plugin.name),
    onClick: function onClick() {
      return setDialogPlugin(plugin.name);
    }
  }, /*#__PURE__*/React__default.createElement(CloseIcon, null)) : /*#__PURE__*/React__default.createElement(LockedPlugin, null), /*#__PURE__*/React__default.createElement(core.Typography, null, plugin.name)));
}

var InstalledPlugin$1 = /*#__PURE__*/mobxReact.observer(InstalledPlugin);
...
function InstalledPluginsList(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(core.List, null, externalPlugins.length ? externalPlugins.filter(function (plugin) {
    return plugin.name.toLowerCase().includes(model.filterText.toLowerCase());
  }).map(function (plugin) {
    return /*#__PURE__*/React__default.createElement(InstalledPlugin$1, {
      key: plugin.name,
      plugin: plugin,
      model: model
    });
  }) : /*#__PURE__*/React__default.createElement(core.Typography, null, "No plugins currently installed"));
}
...
function PluginCard(_ref) {
  ...
  var _getEnv = mobxStateTree.getEnv(model),
  ...
  return /*#__PURE__*/React__default.createElement(core.Card, {
  ...
  }, /*#__PURE__*/React__default.createElement(core.CardContent, null, /*#__PURE__*/React__default.createElement("div", {
    ...
    target: "_blank",
    rel: "noopener"
  }, plugin.name))), /*#__PURE__*/React__default.createElement("div", {
    className: classes.dataField
  }, /*#__PURE__*/React__default.createElement(PersonIcon, {
    style: {
      marginRight: '0.5em'
    }
  }), /*#__PURE__*/React__default.createElement(core.Typography, null, plugin.authors.join(', '))), /*#__PURE__*/React__default.createElement(core.Typography, {
    className: classes.bold
  }, "Description:"), /*#__PURE__*/React__default.createElement(core.Typography, null, plugin.description)), /*#__PURE__*/React__default.createElement(core.CardActions, null, /*#__PURE__*/React__default.createElement(core.Button, {
    variant: "contained",
    color: "primary",
    disabled: disableButton,
    startIcon: isInstalled ? /*#__PURE__*/React__default.createElement(CheckIcon, null) : /*#__PURE__*/React__default.createElement(AddIcon, null),
    onClick: function onClick() {
      if (adminMode) {
        jbrowse.addPlugin({
          name: plugin.name,
...
function PluginStoreWidget(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("div", null, adminMode && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, !util.isElectron && /*#__PURE__*/React__default.createElement("div", {
  ...
  }), /*#__PURE__*/React__default.createElement(core.Typography, null, "You are using the ", /*#__PURE__*/React__default.createElement("code", null, "admin-server"), ". Any changes you make will be saved to your configuration file. You also have the ability to add custom plugins that are not in the store.")), /*#__PURE__*/React__default.createElement("div", {
  ...
  }), /*#__PURE__*/React__default.createElement(core.Accordion, {
    ...
    variant: "h5"
  }, "Installed plugins")), /*#__PURE__*/React__default.createElement("div", {
    style: {
      margin: '1em'
    }
  }, /*#__PURE__*/React__default.createElement(InstalledPluginsList$1, {
  ...
  }) : /*#__PURE__*/React__default.createElement(core.Typography, null, "Loading...")));
}

var PluginStoreWidget$1 = /*#__PURE__*/mobxReact.observer(PluginStoreWidget);
...
function f$1(pluginManager) {
  return mobxStateTree.types.model('PluginStoreModel', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('PluginStoreWidget'),
    filterText: '',
    view: mobxStateTree.types.safeReference(pluginManager.pluggableMstType('view', 'stateModel'))
  }).actions(function (self) {
    return {
...
var configSchema$3 = /*#__PURE__*/configuration.ConfigurationSchema('PluginStoreWidget', {});

var SetDefaultSession = /*#__PURE__*/React.lazy(function () {
  return Promise.resolve().then(function () { return index; });
});
var AssemblyManager = /*#__PURE__*/React.lazy(function () {
...
var useStyles$5 = /*#__PURE__*/styles.makeStyles(function () {
  return {
    table: {
      minWidth: 500,
      minHeight: 150
...
var AssemblyTable = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  var rows = rootModel.jbrowse.assemblies.map(function (assembly) {
    var name = configuration.readConfObject(assembly, 'name');
    var aliases = configuration.readConfObject(assembly, 'aliases');
    return /*#__PURE__*/React__default.createElement(TableRow, {
      key: name
    }, /*#__PURE__*/React__default.createElement(TableCell, null, name), /*#__PURE__*/React__default.createElement(TableCell, null, aliases ? aliases.toString() : ''), /*#__PURE__*/React__default.createElement(TableCell, {
    ...
    }, /*#__PURE__*/React__default.createElement(CreateIcon, {
      color: "primary"
    })), /*#__PURE__*/React__default.createElement(core.IconButton, {
  ...
  }, /*#__PURE__*/React__default.createElement(TableHead, null, /*#__PURE__*/React__default.createElement(TableRow, null, /*#__PURE__*/React__default.createElement(TableCell, null, /*#__PURE__*/React__default.createElement(Typography, {
    variant: "h5"
  }, "Name")), /*#__PURE__*/React__default.createElement(TableCell, null, /*#__PURE__*/React__default.createElement(Typography, {
    variant: "h5"
  }, "Aliases")), /*#__PURE__*/React__default.createElement(TableCell, null, /*#__PURE__*/React__default.createElement(Typography, {
    variant: "h5"
  }, "Actions")))), /*#__PURE__*/React__default.createElement(TableBody, null, rows)));
});
...
var AdapterSelector = /*#__PURE__*/mobxReact.observer(function (_ref) {
...
var AdapterInput = /*#__PURE__*/mobxReact.observer(function (_ref2) {
  ...
  if (adapterSelection === 'IndexedFastaAdapter' || adapterSelection === 'BgzipFastaAdapter') {
    return /*#__PURE__*/React__default.createElement(core.Grid, {
      ...
      item: true
    }, /*#__PURE__*/React__default.createElement(FileSelector, {
      name: "fastaLocation",
    ...
    })), adapterSelection === 'BgzipFastaAdapter' ? /*#__PURE__*/React__default.createElement(core.Grid, {
      item: true
    }, /*#__PURE__*/React__default.createElement(FileSelector, {
      name: "gziLocation",
  ...
  if (adapterSelection === 'TwoBitAdapter') {
    return /*#__PURE__*/React__default.createElement(FileSelector, {
      name: "twoBitLocation",
...
var AssemblyAddForm = /*#__PURE__*/mobxReact.observer(function (_ref3) {
  ...
  var _useState3 = React.useState(adapterTypes[0]),
      _useState4 = _slicedToArray(_useState3, 2),
  ...
  }), /*#__PURE__*/React__default.createElement(AdapterSelector, {
    adapterSelection: adapterSelection,
    setAdapterSelection: setAdapterSelection,
    adapterTypes: adapterTypes
  }), /*#__PURE__*/React__default.createElement("div", {
    className: classes.paperContent
  }, /*#__PURE__*/React__default.createElement(AdapterInput, {
    adapterSelection: adapterSelection,
    fastaLocation: fastaLocation,
...
var AssemblyEditor = /*#__PURE__*/mobxReact.observer(function (_ref) {
  var assembly = _ref.assembly;
  return /*#__PURE__*/React__default.createElement(pluginConfig.ConfigurationEditor, {
    model: {
      target: assembly
    }
  });
...
var AssemblyManager$1 = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(Dialog, {
    ...
    className: classes.titleBox
  }, showAssemblyTable ? 'Assembly manager' : null, isFormOpen ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(_.IconButton, {
    "aria-label": "back",
    className: classes.backButton,
    onClick: function onClick() {
      return setFormOpen(false);
    }
  }, /*#__PURE__*/React__default.createElement(ArrowBackIosIcon, null)), "Add new assembly") : null, isAssemblyBeingEdited ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(_.IconButton, {
    "aria-label": "back",
    className: classes.backButton,
    onClick: function onClick() {
      return setIsAssemblyBeingEdited(false);
    }
  }, /*#__PURE__*/React__default.createElement(ArrowBackIosIcon, null)), returnAssemblyName(assemblyBeingEdited)) : null, /*#__PURE__*/React__default.createElement(_.IconButton, {
    "aria-label": "close",
    className: classes.closeButton,
    onClick: function onClick() {
      return _onClose(false);
    }
  }, /*#__PURE__*/React__default.createElement(CloseIcon, null))), /*#__PURE__*/React__default.createElement(DialogContent, null, /*#__PURE__*/React__default.createElement("div", {
    className: classes.dialogContent
  }, showAssemblyTable ? /*#__PURE__*/React__default.createElement(AssemblyTable, {
    rootModel: rootModel,
    setIsAssemblyBeingEdited: setIsAssemblyBeingEdited,
    setAssemblyBeingEdited: setAssemblyBeingEdited
  }) : null, isAssemblyBeingEdited ? /*#__PURE__*/React__default.createElement(AssemblyEditor, {
    assembly: assemblyBeingEdited
  }) : null, isFormOpen ? /*#__PURE__*/React__default.createElement(AssemblyAddForm, {
    rootModel: rootModel,
    setFormOpen: setFormOpen
  }) : null)), /*#__PURE__*/React__default.createElement(DialogActions, null, showAssemblyTable ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Button, {
    color: "secondary",
    variant: "contained",
    onClick: function onClick() {
      return _onClose(false);
...
var CloseConnectionDialog = /*#__PURE__*/React.lazy(function () {
  return Promise.resolve().then(function () { return CloseConnectionDialog$3; });
});
var DeleteConnectionDialog = /*#__PURE__*/React.lazy(function () {
  return Promise.resolve().then(function () { return DeleteConnectionDialog$3; });
});
var ManageConnectionsDialog = /*#__PURE__*/React.lazy(function () {
...
var HierarchicalTree = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(reactVtree.VariableSizeTree, {
    ref: treeRef,
    treeWalker: treeWalker,
    height: height
  }, Node), /*#__PURE__*/React__default.createElement(JBrowseMenu, {
...
var AutoSizedHierarchicalTree = function AutoSizedHierarchicalTree(_ref2) {
  var tree = _ref2.tree,
      model = _ref2.model,
      offset = _ref2.offset;
  return typeof jest === 'undefined' ? /*#__PURE__*/React__default.createElement(AutoSizer, {
    disableWidth: true
  }, function (_ref3) {
    var height = _ref3.height;
    return /*#__PURE__*/React__default.createElement(HierarchicalTree, {
      height: height - offset,
      model: model,
      tree: tree
    });
  }) : /*#__PURE__*/React__default.createElement(HierarchicalTree, {
    height: 9000,
    model: model,
    tree: tree
  });
...
var Wrapper = function Wrapper(_ref4) {
  ...
  return overrideDimensions ? /*#__PURE__*/React__default.createElement("div", {
...
var HierarchicalTrackSelectorContainer = /*#__PURE__*/mobxReact.observer(function (_ref5) {
  ...
  }, /*#__PURE__*/React__default.createElement(HierarchicalTrackSelector, {
    model: model,
  ...
  }, /*#__PURE__*/React__default.createElement(AddIcon, null)), /*#__PURE__*/React__default.createElement(core.Menu, {
    anchorEl: anchorEl,
...
var HierarchicalTrackSelectorHeader = /*#__PURE__*/mobxReact.observer(function (_ref6) {
  ...
  function breakConnection(connectionConf, deletingConnection) {
    var name = configuration.readConfObject(connectionConf, 'name');
  ...
  return /*#__PURE__*/React__default.createElement("div", {
  ...
  }, modalInfo ? /*#__PURE__*/React__default.createElement(CloseConnectionDialog, {
    modalInfo: modalInfo,
    ...
    session: session
  }) : null, connectionManagerOpen ? /*#__PURE__*/React__default.createElement(ManageConnectionsDialog, {
    handleClose: function handleClose() {
      return setConnectionManagerOpen(false);
    },
    breakConnection: breakConnection,
    session: session
  }) : null, connectionToggleOpen ? /*#__PURE__*/React__default.createElement(ToggleConnectionsDialog, {
    handleClose: function handleClose() {
...
var HierarchicalTrackSelector = /*#__PURE__*/mobxReact.observer(function (_ref8) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(HierarchicalTrackSelectorHeader, {
    model: model,
    setHeaderHeight: setHeaderHeight,
    setAssemblyIdx: setAssemblyIdx,
    assemblyIdx: assemblyIdx
  }), /*#__PURE__*/React__default.createElement(AutoSizedHierarchicalTree, {
    tree: nodes,
    model: model,
...
function UnknownAdapterPrompt(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Typography, {
    ...
    target: "_blank",
    rel: "noopener noreferrer"
  }, "file an issue"), ' ', "and add a feature request for this data type."), /*#__PURE__*/React__default.createElement(TextField, {
    className: classes.spacing,
    value: adapterHint,
    label: "adapterType",
...
function ConfirmTrack(_ref3) {
  ...
  if ((trackAdapter === null || trackAdapter === void 0 ? void 0 : trackAdapter.type) === tracks.UNKNOWN) {
    return /*#__PURE__*/React__default.createElement(UnknownAdapterPrompt, {
      model: model
    });
  }
...
function AddTrackWidget(_ref) {
  ...
  function getStepContent(step) {
    switch (step) {
      ...
      case 1:
        return /*#__PURE__*/React__default.createElement(ConfirmTrack$1, {
          model: model
        });

      default:
        return /*#__PURE__*/React__default.createElement(core.Typography, null, "Unknown step");
    }
  }
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: classes.root
  }, /*#__PURE__*/React__default.createElement(core.Stepper, {
    className: classes.stepper,
    activeStep: activeStep,
    orientation: "vertical"
  }, steps.map(function (label, idx) {
    return /*#__PURE__*/React__default.createElement(core.Step, {
      key: label
    }, /*#__PURE__*/React__default.createElement(core.StepLabel, null, label), /*#__PURE__*/React__default.createElement(core.StepContent, null, getStepContent(idx), /*#__PURE__*/React__default.createElement("div", {
...
var AddTrackWidget$1 = /*#__PURE__*/mobxReact.observer(AddTrackWidget);
...
var ConfigureConnection = /*#__PURE__*/mobxReact.observer(function (props) {
  var connectionType = props.connectionType,
      model = props.model,
      setModelReady = props.setModelReady;
  var ConfigEditorComponent = connectionType.configEditorComponent || pluginConfig.ConfigurationEditor;
  ...
  }, /*#__PURE__*/React__default.createElement(ConfigEditorComponent, {
    model: {
      target: model
    },
...
function ConnectionTypeSelect(props) {
  ...
  return /*#__PURE__*/React__default.createElement("form", {
    ...
    helperText: connectionType.description ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, connectionType.description, connectionType.url ? /*#__PURE__*/React__default.createElement(IconButton, {
      href: connectionType.url,
      rel: "noopener noreferrer",
      target: "_blank",
      color: "secondary"
    }, /*#__PURE__*/React__default.createElement(OpenInNewIcon, null)) : null) : null,
    select: true,
    fullWidth: true,
    onChange: handleChange,
    variant: "outlined"
...
function AddConnectionWidget(_ref) {
  ...
  function handleSetConnectionType(newConnectionType) {
    ...
    }, mobxStateTree.getEnv(model)));
  }

  function stepContent() {
    switch (activeStep) {
      case 0:
        return /*#__PURE__*/React__default.createElement(ConnectionTypeSelect, {
      ...
      case 1:
        return /*#__PURE__*/React__default.createElement(ConfigureConnection, {
          connectionType: connectionType,
          model: configModel,
      ...
      default:
        return /*#__PURE__*/React__default.createElement(Typography, null, "Unknown step");
    }
  }
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    return /*#__PURE__*/React__default.createElement(Step, {
      key: label
    }, /*#__PURE__*/React__default.createElement(StepLabel, null, label), /*#__PURE__*/React__default.createElement(StepContent, null, stepContent(), /*#__PURE__*/React__default.createElement("div", {
      className: classes.actionsContainer
    }, /*#__PURE__*/React__default.createElement(Button, {
      disabled: activeStep === 0,
      onClick: handleBack,
...
var AddConnectionWidget$1 = /*#__PURE__*/mobxReact.observer(AddConnectionWidget);
...
function CloseConnectionDialog$1(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    open: true
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Close connection \"", name, "\""), /*#__PURE__*/React__default.createElement(core.DialogContent, null, dereferenceTypeCount ? /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(core.DialogContentText, null, "Closing this connection will close:"), /*#__PURE__*/React__default.createElement(core.List, null, Object.entries(dereferenceTypeCount).map(function (_ref2) {
  ...
  }))) : null, /*#__PURE__*/React__default.createElement(core.DialogContentText, null, "Are you sure you want to close this connection?")), /*#__PURE__*/React__default.createElement(core.DialogActions, null, /*#__PURE__*/React__default.createElement(core.Button, {
    onClick: function onClick() {
      setModalInfo();
    },
    color: "primary"
...
var CloseConnectionDialog$2 = /*#__PURE__*/mobxReact.observer(CloseConnectionDialog$1);
...
function DeleteConnectionDialog$1(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    open: true
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Delete connection \"", name, "\""), /*#__PURE__*/React__default.createElement(core.DialogContent, null, /*#__PURE__*/React__default.createElement(core.DialogContentText, null, "Are you sure you want to delete this connection?")), /*#__PURE__*/React__default.createElement(core.DialogActions, null, /*#__PURE__*/React__default.createElement(core.Button, {
    onClick: function onClick() {
      return handleClose();
    },
    color: "primary"
...
var DeleteConnectionDialog$2 = /*#__PURE__*/mobxReact.observer(DeleteConnectionDialog$1);
...
function ManageConnectionsDlg(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    ...
    onClose: handleClose,
    maxWidth: "lg"
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Delete connections", /*#__PURE__*/React__default.createElement(core.IconButton, {
    className: classes.closeButton,
    onClick: function onClick() {
      return handleClose();
    }
  }, /*#__PURE__*/React__default.createElement(CloseIcon, null))), /*#__PURE__*/React__default.createElement(core.DialogContent, null, /*#__PURE__*/React__default.createElement(core.Typography, null, "Click the X icon to delete the connection from your config completely"), /*#__PURE__*/React__default.createElement("div", {
    ...
    }, /*#__PURE__*/React__default.createElement(core.Typography, null, adminMode || sessionConnections !== null && sessionConnections !== void 0 && sessionConnections.includes(conf) ? /*#__PURE__*/React__default.createElement(core.IconButton, {
      onClick: function onClick() {
    ...
    }, /*#__PURE__*/React__default.createElement(core.IconButton, null, /*#__PURE__*/React__default.createElement(CloseIcon, {
      color: "disabled"
    }))), name));
  }), !connections.length ? /*#__PURE__*/React__default.createElement(core.Typography, null, "No connections found") : null)), /*#__PURE__*/React__default.createElement(core.DialogActions, null, /*#__PURE__*/React__default.createElement(core.Button, {
    onClick: function onClick() {
      return handleClose();
    },
    variant: "contained",
...
var ManageConnectionsDialog$1 = /*#__PURE__*/mobxReact.observer(ManageConnectionsDlg);
...
function ToggleConnectionDialog(_ref) {
  ...
  var assemblySpecificConnections = connections.filter(function (c) {
    var configAssemblyNames = configuration.readConfObject(c, 'assemblyNames');
  ...
  return /*#__PURE__*/React__default.createElement(core.Dialog, {
    ...
    onClose: handleClose,
    maxWidth: "lg"
  }, /*#__PURE__*/React__default.createElement(core.DialogTitle, null, "Turn on/off connections", /*#__PURE__*/React__default.createElement(core.IconButton, {
    className: classes.closeButton,
    onClick: function onClick() {
      return handleClose();
    }
  }, /*#__PURE__*/React__default.createElement(CloseIcon, null))), /*#__PURE__*/React__default.createElement(core.DialogContent, null, /*#__PURE__*/React__default.createElement(core.Typography, null, "Use the checkbox to turn on/off connections"), /*#__PURE__*/React__default.createElement("div", {
    className: classes.connectionContainer
      ...
      control: /*#__PURE__*/React__default.createElement(core.Checkbox, {
        ...
        onChange: function onChange() {
          if (connectionInstances !== null && connectionInstances !== void 0 && connectionInstances.find(function (conn) {
            return conn.name === configuration.readConfObject(conf, 'name');
          })) {
  ...
  }), !assemblySpecificConnections.length ? /*#__PURE__*/React__default.createElement(core.Typography, null, "No connections found for ", assemblyName) : null)), /*#__PURE__*/React__default.createElement(core.DialogActions, null, /*#__PURE__*/React__default.createElement(core.Button, {
    onClick: function onClick() {
      return handleClose();
    },
    variant: "contained",
...
var ToggleConnectionsDialog$1 = /*#__PURE__*/mobxReact.observer(ToggleConnectionDialog);
...
//# sourceMappingURL=plugin-data-management.cjs.development.js.map
