...
var ConfigurationEditorStateModelFactory = (function (pluginManager) {
  return mobxStateTree.types.model('ConfigurationEditorWidget', {
    id: mst.ElementId,
    type: mobxStateTree.types.literal('ConfigurationEditorWidget'),
...
var configSchema = /*#__PURE__*/configuration.ConfigurationSchema('ConfigurationEditorWidget', {});
var HeadingComponent = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  if (model && model.target) {
    ...
    if (mobxStateTree.isStateTreeNode(model.target)) {
      var type = mobxStateTree.getType(model.target);
          ...
          return runtime_1.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return superGetFeatures.call(_this, region).pipe(operators.toArray()).toPromise();
...
var regionsConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('FromConfigRegionsAdapter', {
  features: {
    type: 'frozen',
    defaultValue: []
  },
...
var sequenceConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('FromConfigSequenceAdapter', {
  features: {
    type: 'frozen',
    defaultValue: []
  },
...
var refNameAliasAdapterConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('RefNameAliasAdapter', {
  location: {
    type: 'fileLocation',
    defaultValue: {
...
function JsonEditor(_ref) {
  ...
  var debouncedJson = util.useDebounce(contents, 400);
...
JsonEditor.propTypes = {
  slot: mobxReact.PropTypes.objectOrObservableObject.isRequired
};
var JsonEditor$1 = /*#__PURE__*/mobxReact.observer(JsonEditor);

var ConfigurationEditorComponent = /*#__PURE__*/React.lazy(function () {
...
function CallbackEditor(_ref) {
  ...
  var debouncedCode = util.useDebounce(code, 400);
  React.useEffect(function () {
    try {
...
function ColorEditorSlot(props) {
  var slot = props.slot;
  return /*#__PURE__*/React__default.createElement(ColorSlot, {
    label: slot.name,
    value: slot.value,
...
var ColorEditor = /*#__PURE__*/mobxReact.observer(ColorEditorSlot);

var StringEditor = /*#__PURE__*/mobxReact.observer(function (_ref) {
  var slot = _ref.slot;
...
var TextEditor = /*#__PURE__*/mobxReact.observer(function (_ref2) {
  var slot = _ref2.slot;
  return /*#__PURE__*/React__default.createElement(core.TextField, {
    label: slot.name,
    helperText: slot.description,
...
var SvgCheckbox = function SvgCheckbox() {
  return /*#__PURE__*/React__default.createElement(core.SvgIcon, null, /*#__PURE__*/React__default.createElement("path", {
...
var StringArrayEditor = /*#__PURE__*/mobxReact.observer(function (_ref3) {
  var slot = _ref3.slot;
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, slot.name ? /*#__PURE__*/React__default.createElement(core.InputLabel, null, slot.name) : null, /*#__PURE__*/React__default.createElement(core.List, {
    disablePadding: true
    ...
    return /*#__PURE__*/React__default.createElement(core.ListItem, {
      ...
      InputProps: {
        endAdornment: /*#__PURE__*/React__default.createElement(core.InputAdornment, null, /*#__PURE__*/React__default.createElement(core.IconButton, {
          color: "secondary",
          onClick: function onClick() {
...
var useMapEditorStyles = /*#__PURE__*/core.makeStyles(function (theme) {
  return {
    card: {
...
var StringArrayMapEditor = /*#__PURE__*/mobxReact.observer(function (_ref4) {
  var slot = _ref4.slot;
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(core.InputLabel, null, slot.name), Array.from(slot.value, function (_ref5) {
    ...
    return /*#__PURE__*/React__default.createElement(core.Card, {
      ...
      title: key,
      action: /*#__PURE__*/React__default.createElement(core.IconButton, {
        color: "secondary",
        onClick: function onClick() {
          return slot.remove(key);
        }
      }, /*#__PURE__*/React__default.createElement(DeleteIcon, null))
    }), /*#__PURE__*/React__default.createElement(core.CardContent, null, /*#__PURE__*/React__default.createElement(StringArrayEditor, {
      slot: {
        value: val,
...
var NumberMapEditor = /*#__PURE__*/mobxReact.observer(function (_ref7) {
  var slot = _ref7.slot;
  var classes = useMapEditorStyles();
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(core.InputLabel, null, slot.name), Array.from(slot.value, function (_ref8) {
    ...
    }), /*#__PURE__*/React__default.createElement(core.CardContent, null, /*#__PURE__*/React__default.createElement(NumberEditor, {
      slot: {
        value: val,
...
var NumberEditor = /*#__PURE__*/mobxReact.observer(function (_ref10) {
  var slot = _ref10.slot;

  var _useState7 = React.useState(slot.value),
...
var IntegerEditor = /*#__PURE__*/mobxReact.observer(function (_ref11) {
  var slot = _ref11.slot;

  var _useState9 = React.useState(slot.value),
...
var booleanEditor = /*#__PURE__*/mobxReact.observer(function (_ref12) {
  var slot = _ref12.slot;
  return /*#__PURE__*/React__default.createElement(core.FormControl, null, /*#__PURE__*/React__default.createElement(core.FormControlLabel, {
    label: slot.name,
...
var stringEnumEditor = /*#__PURE__*/mobxReact.observer(function (_ref13) {
  var slot = _ref13.slot,
      slotSchema = _ref13.slotSchema;
  var p = mobxStateTree.getPropertyMembers(mstReflection.getSubType(slotSchema));
  var choices = mstReflection.getUnionSubTypes(mstReflection.getUnionSubTypes(mstReflection.getSubType(mstReflection.getPropertyType(p, 'value')))[1]).map(function (t) {
    return t.value;
  });
  return /*#__PURE__*/React__default.createElement(core.TextField, {
    value: slot.value,
...
var useSlotEditorStyles = /*#__PURE__*/core.makeStyles(function (theme) {
  return {
    paper: {
      display: 'flex',
...
var SlotEditor = /*#__PURE__*/mobxReact.observer(function (_ref15) {
  ...
  return /*#__PURE__*/React__default.createElement(core.Paper, {
  ...
  }, /*#__PURE__*/React__default.createElement(ValueComponent, {
    slot: slot,
    slotSchema: slotSchema
  })), /*#__PURE__*/React__default.createElement("div", {
    className: classes.slotModeSwitch
  }, slot.contextVariable.length ? /*#__PURE__*/React__default.createElement(core.IconButton, {
    ...
    color: "secondary"
  }, !slot.isCallback ? /*#__PURE__*/React__default.createElement(RadioButtonUncheckedIcon, null) : /*#__PURE__*/React__default.createElement(SvgCheckbox, null)) : null));
});

var TypeSelector = /*#__PURE__*/mobxReact.observer(function (_ref) {
...
var Member = /*#__PURE__*/mobxReact.observer(function (props) {
  ...
  if (configuration.isConfigurationSchemaType(slotSchema)) {
    ...
    var typeNameChoices = configuration.getTypeNamesFromExplicitlyTypedUnion(slotSchema);

    if (typeNameChoices.length) {
      typeSelector = /*#__PURE__*/React__default.createElement(TypeSelector, {
  ...
  if (configuration.isConfigurationSlotType(slotSchema)) {
    // this is a regular config slot
    return /*#__PURE__*/React__default.createElement(SlotEditor, {
      key: slotName,
      slot: slot,
      slotSchema: slotSchema
    });
...
var Schema = /*#__PURE__*/mobxReact.observer(function (_ref) {
  ...
  return util.iterMap(Object.entries(mobxStateTree.getMembers(schema).properties), function (_ref2) {
    ...
    return /*#__PURE__*/React__default.createElement(Member, {
      key: slotName,
      slotName: slotName,
      slotSchema: slotSchema,
      schema: schema
...
var ConfigurationEditor = /*#__PURE__*/mobxReact.observer(function (_ref4) {
...
//# sourceMappingURL=plugin-config.cjs.development.js.map
