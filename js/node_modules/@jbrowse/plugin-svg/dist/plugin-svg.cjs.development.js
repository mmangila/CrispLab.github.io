...
var BoxRendererType = _interopDefault(require('@jbrowse/core/pluggableElementTypes/renderers/BoxRendererType'));
...
var SceneGraph = _interopDefault(require('@jbrowse/core/util/layouts/SceneGraph'));
...
function Label(props) {
  ...
  var measuredTextWidth = util.measureText(text, fontHeight);
...
function FeatureGlyph(props) {
  ...
  var glyphComponents = [/*#__PURE__*/React__default.createElement(GlyphComponent, _extends({
  ...
  if (shouldShowName) {
    glyphComponents.push( /*#__PURE__*/React__default.createElement(Label, {
      ...
      color: configuration.readConfObject(config, ['labels', 'nameColor'], {
        feature: feature
      }),
  ...
  if (shouldShowDescription) {
    glyphComponents.push( /*#__PURE__*/React__default.createElement(Label, {
      ...
      color: configuration.readConfObject(config, ['labels', 'descriptionColor'], {
        feature: feature
      }),
      fontHeight: fontHeight,
      featureWidth: featureLayout.width,
  ...
  return /*#__PURE__*/React__default.createElement("g", null, glyphComponents);
}
...
FeatureGlyph.propTypes = {
  ...
  region: mst.PropTypes.Region.isRequired,
...
var FeatureGlyph$1 = /*#__PURE__*/mobxReact.observer(FeatureGlyph);
...
function OverlayRect(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement("rect", Object.assign({
    x: leftWithinBlock - 2,
    y: rectTop - 2,
...
function SvgOverlay(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, mouseoverFeatureId ? /*#__PURE__*/React__default.createElement(OverlayRect, {
  ...
  }) : null, selectedFeatureId ? /*#__PURE__*/React__default.createElement(OverlayRect, {
...
var SvgOverlay$1 = /*#__PURE__*/mobxReact.observer(SvgOverlay);
...
function Box(props) {
  ...
  var screenWidth = (region.end - region.start) / bpPerPx;
  var color1 = configuration.readConfObject(config, 'color1', {
    feature: feature
  });
  var emphasizedColor1;

  try {
    emphasizedColor1 = color.emphasize(color1, 0.3);
  } catch (error) {
    emphasizedColor1 = color1;
  }

  var color2 = configuration.readConfObject(config, 'color2', {
    feature: feature
  });
...
var Box$1 = /*#__PURE__*/mobxReact.observer(Box);
...
function Chevron(props) {
  ...
  var color$1 = isUTR$1(feature) ? configuration.readConfObject(config, 'color3', {
    feature: feature
  }) : configuration.readConfObject(config, 'color1', {
    feature: feature
  });
  var emphasizedColor;

  try {
    emphasizedColor = color.emphasize(color$1, 0.3);
  } catch (error) {
    emphasizedColor = color$1;
  }
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("rect", {
    ...
    stroke: selected ? color2 : undefined,
    fill: selected ? emphasizedColor : color$1,
    x: leftWithinBlock,
    y: top,
    width: widthWithinBlock,
    height: height
  }), direction < 0 && diff === 0 ? /*#__PURE__*/React__default.createElement("polygon", {
    stroke: selected ? color2 : undefined,
    fill: selected ? emphasizedColor : color$1,
    points: [[left, top], [left - height / 2, top + height / 2], [left, top + height]]
  }) : null, direction > 0 && leftWithinBlock + widthWithinBlock < screenWidth ? /*#__PURE__*/React__default.createElement("polygon", {
    stroke: selected ? color2 : undefined,
    fill: selected ? emphasizedColor : color$1,
...
var Chevron$1 = /*#__PURE__*/mobxReact.observer(Chevron);
...
function Segments(props) {
  ...
  try {
    emphasizedColor2 = color.emphasize(color2, 0.3);
  } catch (error) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement("polyline", {
    "data-testid": feature.id(),
  ...
  subfeatures.map(function (subfeature) {
    ...
    return /*#__PURE__*/React__default.createElement(GlyphComponent, _extends({
...
var Segments$1 = /*#__PURE__*/mobxReact.observer(Segments);
...
function ProcessedTranscript(props) {
  ...
  return /*#__PURE__*/React__default.createElement(Segments$1, _extends({}, props, {
...
function makeSubpartsFilter() {
  ...
  var filter = configuration.readConfObject(config, confKey);
...
function getSubparts(f, config) {
  ...
  if (impliedUTRs || configuration.readConfObject(config, 'impliedUTRs')) {
    c = makeUTRs(f, c);
  }
...
var ProcessedTranscript$1 = /*#__PURE__*/mobxReact.observer(ProcessedTranscript);

function Subfeatures(props) {
  var feature = props.feature,
      featureLayout = props.featureLayout,
      selected = props.selected;
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, feature.get('subfeatures').map(function (subfeature) {
    var subfeatureId = String(subfeature.id());
...
Subfeatures.layOut = function (_ref) {
  ...
  if (displayMode !== 'reducedRepresentation') {
    ...
    subfeatures.forEach(function (subfeature) {
      ...
      var subfeatureHeight = configuration.readConfObject(config, 'height', {
        feature: subfeature
      });
...
var Subfeatures$1 = /*#__PURE__*/mobxReact.observer(Subfeatures);
...
function layOutFeature(args) {
  ...
  var height = configuration.readConfObject(config, 'height', {
    feature: feature
  });
...
function RenderedFeatureGlyph(props) {
  ...
  var startPx = util.bpToPx(start, region, bpPerPx);
  ...
  if (labelsAllowed) {
    var showLabels = configuration.readConfObject(config, 'showLabels');
    fontHeight = configuration.readConfObject(config, ['labels', 'fontSize'], {
      feature: feature
    });
    expansion = configuration.readConfObject(config, 'maxFeatureGlyphExpansion') || 0;
    name = configuration.readConfObject(config, ['labels', 'name'], {
      feature: feature
    }) || '';
    shouldShowName = /\S/.test(name) && showLabels;
    description = configuration.readConfObject(config, ['labels', 'description'], {
      feature: feature
    }) || '';
    ...
    if (shouldShowName) {
      nameWidth = Math.round(Math.min(util.measureText(name, fontHeight), rootLayout.width + expansion)) + padding;
    ...
    if (shouldShowDescription) {
      ...
      descriptionWidth = Math.round(Math.min(util.measureText(description, fontHeight), rootLayout.width + expansion)) + padding;
  ...
  return /*#__PURE__*/React__default.createElement(FeatureGlyph$1, _extends({
...
var RenderedFeatures = /*#__PURE__*/mobxReact.observer(function (props) {
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      featuresRendered.push( /*#__PURE__*/React__default.createElement(RenderedFeatureGlyph, _extends({
        key: feature.id(),
        feature: feature
      }, props)));
    }
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, featuresRendered);
});
...
function SvgFeatureRendering(props) {
  ...
  var mouseDown = React.useCallback(function (event) {
    setMouseIsDown(true);
  ...
  var mouseUp = React.useCallback(function (event) {
  ...
  var mouseLeave = React.useCallback(function (event) {
  ...
  var mouseOver = React.useCallback(function (event) {
  ...
  var mouseOut = React.useCallback(function (event) {
  ...
  var mouseMove = React.useCallback(function (event) {
    if (mouseIsDown) {
  ...
  if (exportSVG) {
    return /*#__PURE__*/React__default.createElement(RenderedFeatures, _extends({
      features: features,
  ...
  }, /*#__PURE__*/React__default.createElement(RenderedFeatures, _extends({
    features: features,
    displayMode: displayMode
  }, props, {
    region: region,
    movedDuringLastMouseDown: movedDuringLastMouseDown
  })), /*#__PURE__*/React__default.createElement(SvgOverlay$1, _extends({}, props, {
    region: region
  }))));
}
...
SvgFeatureRendering.propTypes = {
  ...
  regions: /*#__PURE__*/ReactPropTypes.arrayOf(mst.PropTypes.Region).isRequired,
  bpPerPx: ReactPropTypes.number.isRequired,
  features: /*#__PURE__*/ReactPropTypes.oneOfType([/*#__PURE__*/ReactPropTypes.instanceOf(Map), /*#__PURE__*/ReactPropTypes.arrayOf( /*#__PURE__*/ReactPropTypes.shape())]),
  config: mst.PropTypes.ConfigSchema.isRequired,
...
var SvgFeatureRendererReactComponent = /*#__PURE__*/mobxReact.observer(SvgFeatureRendering);

var svgFeatureRendererConfigSchema = /*#__PURE__*/configuration.ConfigurationSchema('SvgFeatureRenderer', {
  color1: {
    type: 'color',
  ...
  labels: /*#__PURE__*/configuration.ConfigurationSchema('SvgFeatureLabels', {
    name: {
      type: 'string',
  ...
  displayMode: {
    type: 'stringEnum',
    model: /*#__PURE__*/mobxStateTree.types.enumeration('displayMode', ['normal', 'compact', 'reducedRepresentation', 'collapse']),
...
exports.SvgFeatureRendererReactComponent = SvgFeatureRendererReactComponent;
exports.default = SVGPlugin;
exports.svgFeatureRendererConfigSchema = svgFeatureRendererConfigSchema;
//# sourceMappingURL=plugin-svg.cjs.development.js.map
