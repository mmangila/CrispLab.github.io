...
var BigWigAdapter = /*#__PURE__*/function (_BaseFeatureDataAdapt) {
  ...
  function BigWigAdapter(config) {
    ...
    _this.bigwig = new bbi.BigWig({
      filehandle: io.openLocation(configuration.readConfObject(config, 'bigWigLocation'))
    });
    return _this;
  }
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                return _context4.abrupt("return", stats.rectifyStats(header.totalSummary));
...
var DensityRenderer = /*#__PURE__*/function (_WiggleBaseRenderer) {
  ...
  _createClass(DensityRenderer, [{
    ...
    value: function draw(ctx, props) {
      ...
      if (configuration.readConfObject(config, 'color') === '#f0f') {
...
function TooltipContents(props) {
  ...
  return feature.get('summary') !== undefined ? React__default.createElement("div", null, loc, React__default.createElement("br", null), "Max: ", toP(feature.get('maxScore')), React__default.createElement("br", null), "Avg: ", toP(feature.get('score')), React__default.createElement("br", null), "Min: ", toP(feature.get('minScore'))) : React__default.createElement("div", null, loc, React__default.createElement("br", null), "".concat(toP(feature.get('score'))));
}

var Tooltip = /*#__PURE__*/mobxReact.observer(function (_ref) {
  var model = _ref.model,
      height = _ref.height,
      mouseCoord = _ref.mouseCoord;
  var featureUnderMouse = model.featureUnderMouse;
  var classes = useStyles();
  return featureUnderMouse ? React__default.createElement(React__default.Fragment, null, React__default.createElement(MUITooltip, {
    placement: "right-start",
    className: classes.popper,
    open: true,
    title: React__default.createElement(TooltipContents, {
...
var LinearWiggleDisplay = /*#__PURE__*/mobxReact.observer(function (props) {
  ...
  return React__default.createElement("div", null, React__default.createElement(pluginLinearGenomeView.BaseLinearDisplayComponent, Object.assign({}, props)), ready && stats && needsScalebar ? React__default.createElement("svg", {
    style: {
      position: 'absolute',
      top: 0,
      left: 300,
...
var stateModelFactory = function stateModelFactory(pluginManager, configSchema) {
  return mobxStateTree.types.compose('LinearWiggleDisplay', pluginLinearGenomeView.BaseLinearDisplay, mobxStateTree.types.model({
    ...
    return {
      ...
      get rendererConfig() {
        var configBlob = configuration.getConf(self, ['renderers', this.rendererTypeName]) || {};
    ...
    return {
      ...
      get composedTrackMenuItems() {
        return [].concat(_toConsumableArray(this.hasResolution ? [{
          ...
          onClick: function onClick() {
            util.getSession(self).setDialogComponent(SetMinMaxDlg, {
              model: self
            });
          }
        }, {
          label: 'Set color',
          onClick: function onClick() {
            util.getSession(self).setDialogComponent(SetColorDlg, {
              model: self
            });
          }
        }]);
            ...
            switch (_context4.prev = _context4.next) {
              ...
              case 11:
                ...
                return rpcManager.call(sessionId, 'WiggleGetMultiRegionStats', _objectSpread2(_objectSpread2({}, params), {}, {
                  assemblyName: tracks.getTrackAssemblyNames(self.parentTrack)[0],
        ...
        return runtime_1.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                return _context4.abrupt("return", util.renameRegionsIfNeeded(assemblyManager, _objectSpread2(_objectSpread2({}, args), {}, {
...
function SetColorDialog(props) {
  ...
  return React__default.createElement(core.Dialog, {
  ...
  }), React__default.createElement("br", null), React__default.createElement("div", {
    style: {
      margin: 20
    }
    ...
    color: "secondary",
    variant: "contained"
  }, "Restore default from config"), React__default.createElement(core.Button, {
    variant: "contained",
    color: "primary",
    type: "submit",
    onClick: function onClick() {
