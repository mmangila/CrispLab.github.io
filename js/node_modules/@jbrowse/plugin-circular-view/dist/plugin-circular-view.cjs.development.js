...
var RotateRight = _interopDefault(require('@material-ui/icons/RotateRight'));
...
var BaseChordDisplayModel = /*#__PURE__*/mobxStateTree.types.compose('BaseChordDisplay', models.BaseDisplay, mobxStateTree.types.model({
  bezierRadiusRatio: 0.1,
  assemblyName: mobxStateTree.types.maybe(mobxStateTree.types.string)
}))["volatile"](function () {
  return {
  ...
  return {
    onChordClick: function onChordClick(feature) {
      configuration.getConf(self, 'onChordClick', {
        feature: feature,
        track: track,
  ...
  return {
    get blockDefinitions() {
      var origSlices = util.getContainingView(self).staticSlices;
  ...
  var _getEnv3 = mobxStateTree.getEnv(self),
  ...
  return {
    afterAttach: function afterAttach() {
      util.makeAbortableReaction(self, renderReactionData, renderReactionEffect, {
      ...
      util.makeAbortableReaction(self, function () {
        return {
          assemblyNames: tracks.getTrackAssemblyNames(self.parentTrack),
          adapter: configuration.getConf(mobxStateTree.getParent(self, 2), 'adapter'),
          assemblyManager: util.getSession(self).assemblyManager
        };
      },
      /*#__PURE__*/
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
var baseChordDisplayConfig = /*#__PURE__*/configuration.ConfigurationSchema('BaseChordDisplay', {
  onChordClick: {
    type: 'boolean',
...
var ElisionRulerArc = /*#__PURE__*/mobxReact.observer(function (_ref2) {
  var model = _ref2.model,
      slice = _ref2.slice;
  ...
  var endRadians = slice.endRadians,
      ...
      region = slice.region;
  var startXY = util.polarToCartesian(radiusPx, startRadians);
  var endXY = util.polarToCartesian(radiusPx, endRadians);
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RulerLabel, {
...
var RulerLabel = /*#__PURE__*/mobxReact.observer(function (_ref3) {
  var view = _ref3.view,
      text = _ref3.text,
      ...
      color = _ref3.color;
  var classes = useStyles();
  var textXY = util.polarToCartesian(radiusPx + 5, radians);
  ...
  if (text.length * 6.5 < maxWidthPx) {
    ...
    return /*#__PURE__*/React__default.createElement("text", {
      ...
      transform: "translate(".concat(textXY, ") rotate(").concat(util.radToDeg(radians) + 90, ")"),
      style: {
        fill: color
      }
    }, text, /*#__PURE__*/React__default.createElement("title", null, title || text));
  }

  if (maxWidthPx > 4) {
    // text is rotated perpendicular to the ruler arc
    var overallRotation = util.radToDeg(radians + view.offsetRadians - Math.PI / 2);
    ...
    if (overallRotation >= 180) {
      return /*#__PURE__*/React__default.createElement("text", {
        ...
        textAnchor: "start",
        dominantBaseline: "middle",
        transform: "translate(".concat(textXY, ") rotate(").concat(util.radToDeg(radians), ")"),
        style: {
          fill: color
        }
      }, text, /*#__PURE__*/React__default.createElement("title", null, title || text));
    ...
    return /*#__PURE__*/React__default.createElement("text", {
      ...
      textAnchor: "end",
      dominantBaseline: "middle",
      transform: "translate(".concat(textXY, ") rotate(").concat(util.radToDeg(radians) + 180, ")"),
      style: {
        fill: color
      }
    }, text, /*#__PURE__*/React__default.createElement("title", null, title || text));
...
var RegionRulerArc = /*#__PURE__*/mobxReact.observer(function (_ref4) {
  ...
  if (assembly) {
    color$1 = assembly.getRefNameColor(region.refName);
  }

  if (color$1) {
    try {
      color$1 = color.makeContrasting(color$1, theme.palette.background.paper);
    } catch (error) {
  ...
  return /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RulerLabel, {
    ...
    strokeWidth: 2,
    fill: "none"
  }, /*#__PURE__*/React__default.createElement("title", null, region.refName)));
});
var CircularRuler = /*#__PURE__*/mobxReact.observer(function Ruler(_ref5) {
  var model = _ref5.model,
      slice = _ref5.slice;

  if (slice.region.elided) {
    return /*#__PURE__*/React__default.createElement(ElisionRulerArc, {
      key: util.assembleLocString(slice.region.regions[0]),
      model: model,
      slice: slice
    });
  }

  return /*#__PURE__*/React__default.createElement(RegionRulerArc, {
    key: util.assembleLocString(slice.region),
    model: model,
    slice: slice
  });
});
...
var Controls = /*#__PURE__*/mobxReact.observer(function (_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    color: "secondary"
  }, /*#__PURE__*/React__default.createElement(ZoomOut, null)), /*#__PURE__*/React__default.createElement(core.IconButton, {
    onClick: model.zoomInButton,
    className: classes.iconButton,
    title: "zoom in",
    disabled: !showingFigure || model.atMinBpPerPx,
    color: "secondary"
  }, /*#__PURE__*/React__default.createElement(ZoomIn, null)), /*#__PURE__*/React__default.createElement(core.IconButton, {
    onClick: model.rotateCounterClockwiseButton,
    className: classes.iconButton,
    title: "rotate counter-clockwise",
    disabled: !showingFigure,
    color: "secondary"
  }, /*#__PURE__*/React__default.createElement(RotateLeft, null)), /*#__PURE__*/React__default.createElement(core.IconButton, {
    onClick: model.rotateClockwiseButton,
    className: classes.iconButton,
    title: "rotate clockwise",
    disabled: !showingFigure,
    color: "secondary"
  }, /*#__PURE__*/React__default.createElement(RotateRight, null)), /*#__PURE__*/React__default.createElement(core.IconButton, {
    ...
    color: "secondary"
  }, model.lockedFitToWindow ? /*#__PURE__*/React__default.createElement(LockOutline, null) : /*#__PURE__*/React__default.createElement(LockOpen, null)), model.hideTrackSelectorButton ? null : /*#__PURE__*/React__default.createElement(core.IconButton, {
    onClick: model.activateTrackSelector,
    title: "Open track selector",
    "data-testid": "circular_track_select",
    color: "secondary"
  }, /*#__PURE__*/React__default.createElement(Icons.TrackSelector, null)));
});
var ImportForm = /*#__PURE__*/mobxReact.observer(function (_ref3) {
...
var CircularView$1 = /*#__PURE__*/mobxReact.observer(function (_ref4) {
  var model = _ref4.model;
  var classes = useStyles$1();
  ...
  }, /*#__PURE__*/React__default.createElement(Slices, {
    model: model
  }))))), /*#__PURE__*/React__default.createElement(Controls, {
    model: model,
    showingFigure: showFigure
  }), model.hideVerticalResizeHandle ? null : /*#__PURE__*/React__default.createElement(ui.ResizeHandle, {
...
exports.BaseChordDisplayComponentFactory = BaseChordDisplay;
...
//# sourceMappingURL=plugin-circular-view.cjs.development.js.map
