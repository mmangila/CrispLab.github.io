...
exports.NewEmptySession = NewEmptySession;
...
var emptySessionSnapshot = {
  name: "New session ".concat(new Date().toLocaleString()),
  connections: {}
};

function NewSessionCard(_ref) {
  var name = _ref.name,
...
function NewLinearGenomeViewSession(_ref3) {
  ...
  return /*#__PURE__*/_react.default.createElement(NewSessionCard, {
    ...
    onClick: function onClick() {
      root.setSession(_objectSpread(_objectSpread({}, emptySessionSnapshot), {}, {
        name: "New session ".concat(new Date().toLocaleString()),
        views: [{
